...
echo "kaf groups"
echo "kaf topic create billingapp"
echo "kaf topic create bar"
echo "echo 'Hola, mundo' | kaf produce billingapp"
echo "kaf consume billingapp --commit --group billinggroup"
echo "kaf topics"
echo "kaf groups"
echo

echo -e "${GREEN}Now go back to devenv1 and re-demostrate that the topic/group are truly separate${NOCOLOR}"
echo "kaf topics"
echo "kaf groups"
echo "kaf consume billingapp --group billinggroup"
