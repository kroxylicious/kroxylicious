...
echo -e "${GREEN}Edenhill Kcat${NOCOLOUR}"

echo "Note: kcat -P will send each line as a separate record, but you need to press ^D to actually get kcat to start sending - see  https://github.com/edenhill/kcat/issues/322"
