...
public class ClientConsumerRecord extends BaseConsumerRecord {
    private static final Logger LOGGER = LoggerFactory.getLogger(ClientConsumerRecord.class);
     ...
     * @return the client consumer record
     */
    public static ClientConsumerRecord parseFromJsonString(String response) {
        ObjectMapper objectMapper = new ObjectMapper();

        try {
            return objectMapper.readValue(response, ClientConsumerRecord.class);
        }
