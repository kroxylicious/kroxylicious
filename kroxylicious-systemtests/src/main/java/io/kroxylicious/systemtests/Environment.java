...
public class Environment {
    ...
    public static final String KROXYLICIOUS_OPERATOR_REGISTRY = ENVIRONMENT_VARIABLES.getOrDefault(KROXYLICIOUS_OPERATOR_REGISTRY_ENV, KROXYLICIOUS_OPERATOR_REGISTRY_DEFAULT);
