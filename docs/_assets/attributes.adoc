...
:KubernetesVersion: 1.31 and later
:OpenShiftVersion: 4.18 and later

:OperatorDownload: https://github.com/kroxylicious/kroxylicious/releases[GitHub releases page^]
