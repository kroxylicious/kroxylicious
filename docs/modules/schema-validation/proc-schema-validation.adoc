...
//
// assembly-schema-validation-filter.adoc
...
Replace the token `<rule definition>`  with the YAML either a Schema Validation Rule or a Syntactically Correct
JSON Validation Rule depending on your requirements.
...
NOTE: Schema validation currently has the capability to enforce only JSON Schemas (https://github.com/kroxylicious/kroxylicious/issues/1431[issue])
