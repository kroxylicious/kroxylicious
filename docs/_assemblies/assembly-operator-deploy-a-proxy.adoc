...
include::../_modules/configuring/con-kafkaproxyingress-for-on-cluster-access.adoc[leveloffset=+2]

include::../_modules/configuring/con-kafkaservice-by-bootstrap.adoc[leveloffset=+2]

include::../_modules/configuring/con-virtualkafkacluster-tcp.adoc[leveloffset=+2]
