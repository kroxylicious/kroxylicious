...
passed through to consumer as normal. This supports the use-case where encryption is introduced into a system where
...
include::aws-kms/setup.adoc[leveloffset=3]
...
include::aws-kms/service.adoc[leveloffset=3]
...
include::aws-kms/creating_keys.adoc[leveloffset=3]
