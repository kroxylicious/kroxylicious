...
You want an https://kroxylicious.io/use-cases/#encryption-at-rest[encryption-at-rest solution] for data stored in your Apache Kafka?
...
This diagram shows the important resources that will be deployed by the quickstart.
Arrows on the diagrams explain the flows explain the important flows between them.
The pods shown in yellow run the kafka producer and kafka consumers.
