...
[source,console]
----
$ kubectl apply -n kafka -f https://raw.githubusercontent.com/strimzi/strimzi-kafka-operator/refs/heads/main/examples/kafka/kafka-single-node.yaml
...
$ kubectl delete ns kafka localstack
----
