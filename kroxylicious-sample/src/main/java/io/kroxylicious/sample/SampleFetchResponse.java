...
public class SampleFetchResponse implements FilterFactory<SampleFilterConfig, SampleFilterConfig> {
    ...
    @Override
    public Filter createFilter(FilterFactoryContext context, SampleFilterConfig configuration) {
     ...
     */
    public static class Filter implements FetchResponseFilter {

        private final SampleFilterConfig config;
        private final Timer timer;

        public Filter(SampleFilterConfig config) {
            this.config = config;
            this.timer = Timer
