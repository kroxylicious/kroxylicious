...
import io.kroxylicious.kafka.common.message.KRaftVersionRecord;
...
public class MemoryRecords extends AbstractRecords {
    ...
    private static MemoryRecordsBuilder buildRetainedRecordsInto(RecordBatch originalBatch,
        ...
        TimestampType timestampType = originalBatch.timestampType() == TimestampType.NO_TIMESTAMP_TYPE ? TimestampType.CREATE_TIME : originalBatch.timestampType();
        long logAppendTime = timestampType == TimestampType.LOG_APPEND_TIME ? originalBatch.maxTimestamp() : RecordBatch.NO_TIMESTAMP;
        long baseOffset = originalBatch.magic() >= RecordBatch.MAGIC_VALUE_V2 ? originalBatch.baseOffset() : retainedRecords.get(0).offset();
