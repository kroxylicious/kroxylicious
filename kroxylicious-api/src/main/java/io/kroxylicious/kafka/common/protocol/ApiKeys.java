...
import static io.kroxylicious.kafka.common.protocol.types.Type.BYTES;
import static io.kroxylicious.kafka.common.protocol.types.Type.COMPACT_BYTES;
import static io.kroxylicious.kafka.common.protocol.types.Type.COMPACT_NULLABLE_BYTES;
import static io.kroxylicious.kafka.common.protocol.types.Type.COMPACT_NULLABLE_RECORDS;
import static io.kroxylicious.kafka.common.protocol.types.Type.COMPACT_RECORDS;
import static io.kroxylicious.kafka.common.protocol.types.Type.NULLABLE_BYTES;
import static io.kroxylicious.kafka.common.protocol.types.Type.NULLABLE_RECORDS;
import static io.kroxylicious.kafka.common.protocol.types.Type.RECORDS;
