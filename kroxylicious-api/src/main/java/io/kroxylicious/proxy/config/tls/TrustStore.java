 ...
 * @param clientAuth clientAuth when in the node is in the TLS <em>server</em> role, clientAuth specifies how the server should authenticate clients.
...
public record TrustStore(@JsonProperty(required = true) String storeFile,
                         ...
                         String storeType,
                         @Nullable @JsonProperty(value = "clientAuth") TlsClientAuth clientAuth)
