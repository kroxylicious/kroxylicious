 ...
 * The routing API.
 *
 * <p>A {@link io.kroxylicious.proxy.routing.Router} is a plugin that decides which
 * {@linkplain io.kroxylicious.proxy.routing.RoutingContext#sendRequest route}
 ...
 * {@link io.kroxylicious.proxy.routing.RouterFactory} as the service type.</p>
 */
