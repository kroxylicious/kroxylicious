 ...
 *
 * <h3 id='implementing.FilterCommands'>Filter Results</h3>
 * <p>Filter implementation must return a {@link java.util.concurrent.CompletionStage} containing a
 * {@link io.kroxylicious.proxy.filter.FilterCommand} object. It is the job of FilterCommand to convey what
 ...
 * perform the action described by the FilterCommand.</p>
 ...
 * CompletionStage completes, the action described  by the FilterCommand is performed, reading from the downstream
 ...
 * <h3 id='implementing.createFilterCommands'>Creating Filter Result objects</h3>
 * <p>The {@link io.kroxylicious.proxy.filter.FilterContext} is the factory for the FilterCommand objects.</p>
 ...
 * <ul>
 *     <li>{@link io.kroxylicious.proxy.filter.FilterContext#requestFilterCommandBuilder()} and</li>
 *     <li>{@link io.kroxylicious.proxy.filter.FilterContext#responseFilterCommandBuilder()}.</li>
 * </ul>
 */
