...
import io.kroxylicious.kafka.common.message.EndTxnMarker;
...
public class EndTransactionMarkerTest {
    ...
    public void testSerializeAndDeserialize() {
        for (ControlRecordType type : VALID_CONTROLLER_RECORD_TYPE) {
            for (short version = EndTxnMarker.LOWEST_SUPPORTED_VERSION; version <= EndTxnMarker.HIGHEST_SUPPORTED_VERSION; version++) {
