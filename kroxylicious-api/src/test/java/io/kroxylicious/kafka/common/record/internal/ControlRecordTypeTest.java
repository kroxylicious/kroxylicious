...
import io.kroxylicious.kafka.common.message.ControlRecordTypeSchema;
import io.kroxylicious.kafka.common.protocol.types.Field;
import io.kroxylicious.kafka.common.protocol.types.Schema;
import io.kroxylicious.kafka.common.protocol.types.Struct;
...
public class ControlRecordTypeTest {
    ...
    public void testRoundTrip(ControlRecordType expected) {
        ...
        for (short version = ControlRecordTypeSchema.LOWEST_SUPPORTED_VERSION; version <= ControlRecordTypeSchema.HIGHEST_SUPPORTED_VERSION; version++) {
