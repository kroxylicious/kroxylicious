...
public class KroxyliciousTesterBuilder {
    ...
    private BiFunction<Configuration, Set<Feature>, AutoCloseable> kroxyliciousFactory = DefaultKroxyliciousTester::spawnProxy;
     ...
     * @return the current instance of the builder for chaining in a fluent fashion.
     */
    public KroxyliciousTesterBuilder setKroxyliciousFactory(BiFunction<Configuration, Set<Feature>, AutoCloseable> kroxyliciousFactory) {
    ...
    /**
     * Sets the features of the proxy.
     * @param features features
     * @return the current instance of the builder for chaining in a fluent fashion.
     */
    public KroxyliciousTesterBuilder setFeatures(Set<Feature> features) {
