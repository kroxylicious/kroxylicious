...
<#list inputSpecs as inputSpec>
    <#if inputSpec.type?lower_case == 'request'>
        requestClasses.put(ApiKeys.${inputSpec.apiKeyEnumName}, ${inputSpec.name}Data.class);
    </#if>
    <#if inputSpec.type?lower_case == 'response'>
        responseClasses.put(ApiKeys.${inputSpec.apiKeyEnumName}, ${inputSpec.name}Data.class);
    </#if>
</#list>
    }
