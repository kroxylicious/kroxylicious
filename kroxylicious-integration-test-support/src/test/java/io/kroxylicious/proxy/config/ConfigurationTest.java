...
class ConfigurationTest {
    ...
    @Test
    void proxyProtocolModeShouldReturnAutoWhenAuto() {
        Configuration configuration = new Configuration(null, null, null,
                List.of(buildVirtualCluster("vc", "x:9092", null)),
                null, false, Optional.empty(), null,
                new ProxyProtocolConfig(ProxyProtocolMode.AUTO));
        assertThat(configuration.proxyProtocolMode()).isEqualTo(ProxyProtocolMode.AUTO);
    }
