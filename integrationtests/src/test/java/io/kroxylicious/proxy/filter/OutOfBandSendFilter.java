...
public class OutOfBandSendFilter implements DescribeClusterRequestFilter, DescribeClusterResponseFilter {
    ...
    @Override
    public CompletionStage<? extends FilterResult> onDescribeClusterRequest(short apiVersion, RequestHeaderData header, DescribeClusterRequestData request,
    ...
    @Override
    public CompletionStage<ResponseFilterResult> onDescribeClusterResponse(short apiVersion, ResponseHeaderData header, DescribeClusterResponseData response, KrpcFilterContext context) {
