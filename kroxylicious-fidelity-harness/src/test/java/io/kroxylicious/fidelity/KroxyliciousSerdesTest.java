...
class KroxyliciousSerdesTest {

    // v2 RequestHeaderData wire layout, computed independently of KroxyliciousSerdes/RequestHeaderData.write():
    ...
    void shouldWriteKnownByteLayout() {
        ...
        // When
        byte[] bytes = KroxyliciousSerdes.write(original, (short) 2);
    ...
    void shouldDecodeInlineWithSpecifiedVersion() {
        // When
        ReadResult<RequestHeaderData> result = KroxyliciousSerdes.read(new RequestHeaderData(), KNOWN_BYTES, (short) 1);
    ...
    void shouldReadKnownByteLayoutWithUnknownTaggedField() {
        // When
        ReadResult<RequestHeaderData> result = KroxyliciousSerdes.read(new RequestHeaderData(), KNOWN_BYTES_WITH_UNKNOWN_TAGGED_FIELD, (short) 2);
    ...
    void shouldFailForMalformedInput() {
        // When
        ReadResult<RequestHeaderData> result = KroxyliciousSerdes.read(new RequestHeaderData(), Arrays.copyOfRange(KNOWN_BYTES, 1, KNOWN_BYTES.length), (short) 2);
