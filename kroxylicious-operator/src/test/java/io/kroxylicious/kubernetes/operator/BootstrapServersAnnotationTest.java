...
class BootstrapServersAnnotationTest {
    ...
    void testAnnotate() {
        ...
        String expectedValue = "{\"version\":\"1\",\"bootstrapServers\":[{\"clusterName\":\"a\",\"ingressName\":\"b\",\"bootstrapServers\":\"" + BOOTSTRAP_SERVERS
                + "\"}]}";
    ...
    void testReadAnnotationContainingBootstrapServers() {
        ObjectMeta meta = new ObjectMeta();
        String value = "{\"version\":\"1\",\"bootstrapServers\":[{\"clusterName\":\"a\",\"ingressName\":\"b\",\"bootstrapServers\":\"" + BOOTSTRAP_SERVERS + "\"}]}";
