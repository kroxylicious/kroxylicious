...
class VirtualKafkaClusterReconcilerTest {
    ...
    void kubernetesServicesPrimaryToSecondaryMapper() {
        ...
        // then
        ResourceID clusterIpBootstrapServiceId = new ResourceID("cluster-ingress", "namespace");
    ...
    void kubernetesServicesPrimaryToSecondaryMapperMultipleIngresses() {
        ...
        // then
        ResourceID clusterIpBootstrapServiceId = new ResourceID(clusterName + "-" + ingressName, namespace);
        ResourceID clusterIpBootstrapServiceId2 = new ResourceID(clusterName + "-" + ingressName2, namespace);
