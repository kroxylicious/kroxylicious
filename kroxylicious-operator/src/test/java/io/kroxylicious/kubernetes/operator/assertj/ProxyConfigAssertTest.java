...
class ProxyConfigAssertTest {
    ...
    public static final Configuration EMPTY = new Configuration(null, null, null, List.of(), List.of(), false, Optional.empty());

    @Test
    void virtualClusterWithEmptyClustersList() {
        Assertions.assertThatThrownBy(() -> {
            OperatorAssertions.assertThat(EMPTY).cluster("arbitrary");
        }).hasMessage("proxy config contains no virtual clusters");
    }
