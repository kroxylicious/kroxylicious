...
class SecureConfigInterpolatorTest {
    ...
    void shouldInterpolate() throws JsonProcessingException {
        ...
        assertThat(result.volumes()).element(0).extracting(Volume::getName).isEqualTo("Secret-aws");
        ...
        assertThat(result.volumes()).element(1).extracting(Volume::getName).isEqualTo("Secret-different-secret");
        ...
        assertThat(result.mounts()).element(0).extracting(VolumeMount::getName).isEqualTo("Secret-aws");
        assertThat(result.mounts()).element(0).extracting(VolumeMount::getMountPath).isEqualTo("/base/secret/aws");
        assertThat(result.mounts()).element(1).extracting(VolumeMount::getName).isEqualTo("Secret-different-secret");
