...
class SecretSecondaryJoinedOnIngressTrustAnchorRefToVirtualKafkaClusterPrimaryMapper implements SecondaryToPrimaryMapper<Secret> {
    private final EventSourceContext<VirtualKafkaCluster> context;

    SecretSecondaryJoinedOnIngressTrustAnchorRefToVirtualKafkaClusterPrimaryMapper(EventSourceContext<VirtualKafkaCluster> context) {
