...
public class KafkaProtocolFilterStatusFactory extends StatusFactory<KafkaProtocolFilter> {
    ...
    @Override
    public KafkaProtocolFilter newUnknownConditionStatusPatch(KafkaProtocolFilter observedFilter,
                                                              Condition.Type type,
                                                              Exception e) {
    ...
    @Override
    public KafkaProtocolFilter newFalseConditionStatusPatch(KafkaProtocolFilter observedProxy,
                                                            Condition.Type type,
                                                            String reason,
                                                            String message) {
