...
class SecretJoinedToIngressCertificateRefSecondarytoVirtualKafkaClusterPrimaryMapper implements SecondaryToPrimaryMapper<Secret> {

    private final EventSourceContext<VirtualKafkaCluster> context;

    SecretJoinedToIngressCertificateRefSecondarytoVirtualKafkaClusterPrimaryMapper(EventSourceContext<VirtualKafkaCluster> context) {
