...
public class KafkaProxyIngressStatusFactory extends StatusFactory<KafkaProxyIngress> {
    ...
    @Override
    public KafkaProxyIngress newUnknownConditionStatusPatch(KafkaProxyIngress observedFilter,
                                                            Condition.Type type,
                                                            Exception e) {
    ...
    @Override
    public KafkaProxyIngress newFalseConditionStatusPatch(KafkaProxyIngress observedProxy,
                                                          Condition.Type type,
                                                          String reason,
                                                          String message) {
