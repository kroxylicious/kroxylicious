...
public class VirtualKafkaClusterStatusFactory extends StatusFactory<VirtualKafkaCluster> {
    ...
    @Override
    public VirtualKafkaCluster newUnknownConditionStatusPatch(VirtualKafkaCluster observedFilter,
                                                              Condition.Type type,
                                                              Exception e) {
    ...
    @Override
    public VirtualKafkaCluster newFalseConditionStatusPatch(VirtualKafkaCluster observedProxy,
                                                            Condition.Type type,
                                                            String reason,
                                                            String message) {
