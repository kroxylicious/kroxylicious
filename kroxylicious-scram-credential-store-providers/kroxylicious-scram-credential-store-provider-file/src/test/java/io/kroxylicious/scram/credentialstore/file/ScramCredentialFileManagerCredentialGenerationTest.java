...
/**
 * Tests for {@link ScramCredentialFileManager} credential generation.
 */
class ScramCredentialFileManagerCredentialGenerationTest {
    ...
    void shouldGenerateDeterministicCredentials() throws Exception {
        ...
        var generator = new ScramCredentialFileManager(mockRandom);
    ...
    void shouldRoundTripCredentialsThroughKeyStore(@TempDir Path tempDir) throws Exception {
        ...
        String alias1 = ScramCredentialFileManager.hashUsername(username1);
        String alias2 = ScramCredentialFileManager.hashUsername(username2);
    ...
    void shouldGenerateValidScramSha512Credentials() {
        // Given
        var generator = new ScramCredentialFileManager();
        ...
        // Then
        assertThat(credential.hashAlgorithm()).isEqualTo(ScramHashAlgorithm.SHA_512);
