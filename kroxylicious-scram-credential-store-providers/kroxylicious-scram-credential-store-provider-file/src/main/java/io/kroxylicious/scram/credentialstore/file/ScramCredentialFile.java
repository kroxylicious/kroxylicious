 ...
 * </p>
 */
public class ScramCredentialFile implements ScramCredentialStore {

    private static final Logger LOGGER = LoggerFactory.getLogger(ScramCredentialFile.class);
    ...
    private LoadResult loadKeyStore(ScramCredentialFileConfig config) throws CredentialServiceUnavailableException {
        CredentialFilePermissions.checkForCredentialStore(Path.of(config.file()));
        try {
    ...
    private LoadResult extractCredentialsAndKey(KeyStore keyStore, char[] storePassword) throws CredentialServiceUnavailableException {
        ...
        try {
            ...
            while (aliases.hasMoreElements()) {
                ...
                if (ScramCredentialFileManager.PHANTOM_SALT_KEY_ALIAS.equals(alias)) {
