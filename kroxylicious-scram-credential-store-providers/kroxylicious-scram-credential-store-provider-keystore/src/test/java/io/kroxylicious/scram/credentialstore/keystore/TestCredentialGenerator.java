 ...
 * without the safety checks of {@link KeystoreCredentialManager#createKeyStore}.
 * </p>
 */
public class TestCredentialGenerator {

    private final KeystoreCredentialManager credentialManager;

    public TestCredentialGenerator() {
        this.credentialManager = new KeystoreCredentialManager();
    }

    public TestCredentialGenerator(KeystoreCredentialManager credentialManager) {
    ...
    public void generateKeyStore(
        ...
        for (int i = 0; i < users.length; i += 2) {
            ...
            keyStore.setEntry(KeystoreCredentialManager.hashUsername(username), entry, protection);
        }
