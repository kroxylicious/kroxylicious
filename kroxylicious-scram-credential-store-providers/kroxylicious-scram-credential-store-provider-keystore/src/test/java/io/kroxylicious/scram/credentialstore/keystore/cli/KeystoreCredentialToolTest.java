...
/**
 * Unit tests for {@link KeystoreCredentialTool} CLI logic.
 */
class KeystoreCredentialToolTest {
    ...
    void getPasswordShouldThrowWhenConsoleReturnsNull() {
        ...
        try (MockedStatic<KeystoreCredentialTool> mocked = mockStatic(KeystoreCredentialTool.class, CALLS_REAL_METHODS)) {
            mocked.when(() -> KeystoreCredentialTool.readPasswordFromConsole(anyString()))
                    .thenReturn(null);
    ...
    void scramSha256TypeShouldMapToKafkaMechanism() {
        assertThat(KeystoreCredentialTool.ScramMechanismType.SCRAM_SHA_256.toScramMechanism())
                .isEqualTo(ScramMechanism.SCRAM_SHA_256);
    }

    @Test
    void scramSha512TypeShouldMapToKafkaMechanism() {
        assertThat(KeystoreCredentialTool.ScramMechanismType.SCRAM_SHA_512.toScramMechanism())
