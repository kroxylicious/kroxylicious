...
public class LogHasNoUnexpectedErrors extends BaseMatcher<String> {
    ...
    enum LogIgnoreList {
        ...
        RECOVERY_STS_DELETION(
                "java\\.lang\\.IllegalStateException: Can't wait for StatefulSet: recovery-cluster-(kafka|zookeeper) in namespace: recovery-cluster-test to scale. Resource is no longer available."),
