...
public abstract class Ca {
     ...
     */
    public Ca(Reconciliation reconciliation, PasswordGenerator passwordGenerator, String commonName,
    ...
    // */
    // public void createRenewOrReplace(String namespace, String clusterName, Map<String, String> labels, Map<String, String> additionalLabels, Map<String, String> additionalAnnotations, OwnerReference
    // ownerRef, boolean maintenanceWindowSatisfied) {
