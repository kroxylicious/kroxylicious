 ...
 */
package io.kroxylicious.systemtest.storage;
...
import static io.kroxylicious.systemtest.Constants.MESSAGE_COUNT;
...
final public class TestStorage {
    ...
    public TestStorage(ExtensionContext extensionContext, String namespaceName, int messageCount) {
        ...
        this.kafkaStatefulSetName = Environment.isKafkaNodePoolsEnabled() ? this.clusterName + "-" + this.kafkaNodePoolName
                : KafkaResources.kafkaStatefulSetName(clusterName);
