...
import io.kroxylicious.systemtest.enums.DefaultNetworkPolicy;
import io.kroxylicious.systemtest.resources.ResourceManager;
import io.kroxylicious.systemtest.resources.ResourceType;
import io.kroxylicious.systemtest.templates.kubernetes.NetworkPolicyTemplates;
...
public class NetworkPolicyResource implements ResourceType<NetworkPolicy> {
    ...
    public static <T extends CustomResource<? extends Spec, ? extends Status>> void deployNetworkPolicyForResource(ExtensionContext extensionContext, T resource,
