...
package io.kroxylicious.systemtest.utils;
...
import io.kroxylicious.systemtest.utils.kubeUtils.controllers.StrimziPodSetUtils;
...
public class StUtils {
    ...
    private static final BiFunction<String, Object, Boolean> CONTAINS_ANNOTATION = (annotationName, annotationHolder) -> {
    ...
    public static void waitUntilLogFromPodContainsString(String namespaceName, String podName, String containerName, String timeSince, String exceptedString) {
        TestUtils.waitFor("log from Pod: " + namespaceName + "/" + podName + " to contain string: " + exceptedString, Constants.GLOBAL_POLL_INTERVAL,
    ...
    /**
     * Checking if test case contains annotation {@link io.kroxylicious.systemtest.annotations.ParallelTest}
     * @param annotationHolder context of the test case
     * @return true if test case contains annotation {@link io.kroxylicious.systemtest.annotations.ParallelTest},
     * otherwise false
     */
    ...
    /**
     * Checking if test case contains annotation {@link io.kroxylicious.systemtest.annotations.IsolatedTest}
     * @param annotationHolder context of the test case
     * @return true if test case contains annotation {@link io.kroxylicious.systemtest.annotations.IsolatedTest},
     * otherwise false
     */
    ...
    /**
     * Checking if test case contains annotation {@link io.kroxylicious.systemtest.annotations.ParallelNamespaceTest}
     * @param annotationHolder context of the test case
     * @return true if test case contains annotation {@link io.kroxylicious.systemtest.annotations.ParallelNamespaceTest},
     * otherwise false
     */
    ...
    public static String removePackageName(String testClassPath) {
        return testClassPath.replace("io.kroxylicious.systemtest.", "");
    }
