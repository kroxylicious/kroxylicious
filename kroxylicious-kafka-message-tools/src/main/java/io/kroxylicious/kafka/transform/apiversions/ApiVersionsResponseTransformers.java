...
public class ApiVersionsResponseTransformers {
    ...
    public static ApiVersionsResponseTransformer preventTopicIdBearingProduceRequests() {
        short lastVersionBeforeTopicIdsIntroducedToProduce = (short) 12;
        return limitMaxVersionForApiKeys(Map.of(ApiKeys.PRODUCE, lastVersionBeforeTopicIdsIntroducedToProduce));
    }
