...
class ApiVersionMaxVersionLimiter implements ApiVersionsResponseTransformer {
    ...
    @Override
    public ApiVersionsResponseData onApiVersionsResponse(ApiVersionsResponseData data) {
