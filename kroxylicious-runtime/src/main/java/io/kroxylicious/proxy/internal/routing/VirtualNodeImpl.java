 ...
 *
 * <p>A null {@code nodeId} means "any broker on the route" (produced by
 * {@link io.kroxylicious.proxy.router.RouterContext#anyNode}). A non-null
 * {@code nodeId} identifies a specific target-cluster broker (produced by
 ...
 */
record VirtualNodeImpl(String route, @Nullable Integer nodeId) implements VirtualNode {}
