 ...
 * <p>
 * Includes FilterChainFactory instances to enable filter configuration hot-reload:
 * - oldFilterChainFactory: The currently active factory (before reload)
 * - newFilterChainFactory: The new factory created with updated filter definitions
 */
