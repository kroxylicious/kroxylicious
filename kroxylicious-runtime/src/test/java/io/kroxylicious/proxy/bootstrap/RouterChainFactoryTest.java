...
class RouterChainFactoryTest {
    ...
    private static final List<RouteDefinition> DUMMY_ROUTES = List.of(
            new RouteDefinition("route1", 0, null, new RouteDefinition.Target("someCluster", null)));
    ...
    void shouldCloseFactoriesInReverseOrder() {
        ...
        var routes1 = List.of(new RouteDefinition("r", 0, null, new RouteDefinition.Target(null, "r2")));
    ...
    void shouldInitialiseSubRouters() {
        ...
        var routes1 = List.of(new RouteDefinition("toChild", 0, null, new RouteDefinition.Target(null, "child")));
