...
class PortConflictDetectorTest {
    ...
    public static Stream<Arguments> portConflict() {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        "any:overlap produces exclusive conflict ",
                        createMockVirtualCluster("one", Set.of(9080, 9081), Set.of(), any),
                ...
                Arguments.of(
                        "loopback:single exclusive conflict",
                ...
                Arguments.of(
                        "loopback/any:single exclusive conflict",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), loopback),
                        createMockVirtualCluster("two", Set.of(9080), Set.of(), any),
                ...
                Arguments.of(
                        "any/loopback:single exclusive conflict",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), any),
                        createMockVirtualCluster("two", Set.of(9080), Set.of(), loopback),
                ...
                Arguments.of(
                        "any/loopback:single shared conflict",
                ...
                Arguments.of(
                        "loopback/any:single shared conflict",
                ...
                Arguments.of(
                        "same shared shared ports different interfaces with differing tls",
                ...
                Arguments.of(
                        "same exclusive port different interfaces",
                ...
                Arguments.of(
                        "different exclusive ports, collides with other exclusive port on any interface",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), any),
                        createMockVirtualCluster("two", Set.of(9081), Set.of(), any),
                ...
                Arguments.of(
                        "different exclusive ports on any interface, collides with other exclusive port on specific interface",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), any),
                        createMockVirtualCluster("two", Set.of(9081), Set.of(), any),
                        "The exclusive bind of port(s) 9080 for virtual cluster 'one' to <any> would conflict with another (non-cluster) port binding",
                ...
                Arguments.of(
                        "different exclusive ports on specific interface, collides with other exclusive port on any interface",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), loopback),
                ...
                Arguments.of(
                        "same shared ports, collides with other exclusive port on any interface",
                        createMockVirtualCluster("one", Set.of(), Set.of(9080), any),
                        createMockVirtualCluster("two", Set.of(), Set.of(9080), any),
                ...
                Arguments.of(
                        "same shared shared ports different interfaces with differing tls, collides with other exclusive port",
                        createMockVirtualCluster("one", Set.of(), Set.of(9080), loopback, true),
                        createMockVirtualCluster("two", Set.of(), Set.of(9080), privateUse, false),
                ...
                Arguments.of(
                        "same exclusive port different interfaces, collides with other exclusive port",
                        createMockVirtualCluster("one", Set.of(9080), Set.of(), privateUse),
                        createMockVirtualCluster("two", Set.of(9080), Set.of(), loopback),
