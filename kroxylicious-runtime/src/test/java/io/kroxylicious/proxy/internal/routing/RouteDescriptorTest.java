...
class RouteDescriptorTest {
    ...
    void shouldCreateClusterRoute() {
        var rd = new RouteDescriptor("route-a", TARGET, null, List.of());
    ...
    void shouldCreateRouterRoute() {
        var rd = new RouteDescriptor("route-b", null, "nested-router", List.of());
    ...
    void shouldPreserveFilters() {
        ...
        var rd = new RouteDescriptor("route-c", TARGET, null, List.of(filter));
        assertThat(rd.filters()).containsExactly(filter);
    }

    @Test
    void shouldRejectBothTargetClusterAndRouter() {
        assertThatThrownBy(() -> new RouteDescriptor("bad", TARGET, "router", List.of()))
    ...
    void shouldRejectNeitherTargetClusterNorRouter() {
        assertThatThrownBy(() -> new RouteDescriptor("bad", null, null, List.of()))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("exactly one");
    }
    ...
    void shouldRejectNullName() {
        assertThatThrownBy(() -> new RouteDescriptor(null, TARGET, null, List.of()))
                .isInstanceOf(NullPointerException.class);
    }

    @Test
    void shouldRejectNullFilters() {
        assertThatThrownBy(() -> new RouteDescriptor("route", TARGET, null, null))
                .isInstanceOf(NullPointerException.class);
    }
}
