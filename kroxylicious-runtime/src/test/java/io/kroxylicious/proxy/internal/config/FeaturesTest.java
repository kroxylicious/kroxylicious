...
class FeaturesTest {
    ...
    void supportsValidTestConfiguration(Features features, Map<String, Object> developmentConfig) {
        ...
        Configuration configuration = new Configuration(null, null, List.of(), List.of(), List.of(mockCluster), null, false, Optional.ofNullable(developmentConfig),
                null);
    ...
    void supportsReturnsErrorOnTestConfigurationPresentWithFeatureDisabled() {
        ...
        VirtualCluster mockCluster = mock(VirtualCluster.class);
        when(mockCluster.name()).thenReturn("test");
        Configuration configuration = new Configuration(null, null, List.of(), List.of(), List.of(mockCluster), null, false, a, null);
