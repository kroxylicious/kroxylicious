...
/**
 * Differential test: for every {@link ApiKeys} that {@link VendoredKafkaProxyExceptionMapper} currently handles, across every
 ...
 * {@code VendoredKafkaProxyExceptionMapper}'s switch used to build it).
 * <p>
 ...
 * through yet. Once the migration lands and {@link VendoredKafkaProxyExceptionMapper} is repointed at
 ...
 */
class VendoredKafkaProxyExceptionMapperParityTest {
    ...
    void factoryMatchesKafkaClientsOracle(ApiKeys apiKey, short version) {
        ...
        // When
        ApiMessage actual = VendoredKafkaProxyExceptionMapper.errorResponseData(apiKey, requests.kroxyliciousRequest, version, ERROR, MESSAGE);
    ...
    void produceReturnsNullWhenAcksZero(short version) {
        ...
        // When
        ApiMessage actual = VendoredKafkaProxyExceptionMapper.errorResponseData(ApiKeys.PRODUCE, request, version, ERROR, MESSAGE);
    ...
    void apiVersionsUnsupportedVersionIncludesSupportedApiKeys() {
        ...
        // When
        ApiMessage actual = VendoredKafkaProxyExceptionMapper.errorResponseData(ApiKeys.API_VERSIONS, request, version, Errors.UNSUPPORTED_VERSION, MESSAGE);
    ...
    static Stream<Arguments> coveredApiKeyVersions() {
        return REQUEST_BUILDERS.keySet().stream().flatMap(apiKey -> {
            // use the kafka supported ranges because the vendored versions are ahead
            // TODO revisit once they are synchronized
    ...
    private static Map<ApiKeys, Function<Short, MatchedInput>> requestBuilders() {
        ...
        builders.put(ApiKeys.INCREMENTAL_ALTER_CONFIGS, VendoredKafkaProxyExceptionMapperParityTest::incrementalAlterConfigsInput);
        ...
        builders.put(ApiKeys.DESCRIBE_USER_SCRAM_CREDENTIALS, VendoredKafkaProxyExceptionMapperParityTest::describeUserScramCredentialsInput);
        builders.put(ApiKeys.CREATE_PARTITIONS, VendoredKafkaProxyExceptionMapperParityTest::createPartitionsInput);
        builders.put(ApiKeys.CREATE_TOPICS, VendoredKafkaProxyExceptionMapperParityTest::createTopicsInput);
        ...
        builders.put(ApiKeys.WRITE_SHARE_GROUP_STATE, VendoredKafkaProxyExceptionMapperParityTest::writeShareGroupStateInput);
        builders.put(ApiKeys.INITIALIZE_SHARE_GROUP_STATE, VendoredKafkaProxyExceptionMapperParityTest::initializeShareGroupStateInput);
        builders.put(ApiKeys.DELETE_SHARE_GROUP_STATE, VendoredKafkaProxyExceptionMapperParityTest::deleteShareGroupStateInput);
        builders.put(ApiKeys.READ_SHARE_GROUP_STATE_SUMMARY, VendoredKafkaProxyExceptionMapperParityTest::readShareGroupStateSummaryInput);

        // Chunk 2: moderate structural/version quirks, still no field renames.
        builders.put(ApiKeys.ALTER_CLIENT_QUOTAS, VendoredKafkaProxyExceptionMapperParityTest::alterClientQuotasInput);
        builders.put(ApiKeys.ALTER_CONFIGS, VendoredKafkaProxyExceptionMapperParityTest::alterConfigsInput);
        builders.put(ApiKeys.ALTER_PARTITION_REASSIGNMENTS, VendoredKafkaProxyExceptionMapperParityTest::alterPartitionReassignmentsInput);
        builders.put(ApiKeys.ALTER_REPLICA_LOG_DIRS, VendoredKafkaProxyExceptionMapperParityTest::alterReplicaLogDirsInput);
        ...
        builders.put(ApiKeys.ALTER_USER_SCRAM_CREDENTIALS, VendoredKafkaProxyExceptionMapperParityTest::alterUserScramCredentialsInput);
        ...
        builders.put(ApiKeys.DELETE_TOPICS, VendoredKafkaProxyExceptionMapperParityTest::deleteTopicsInput);
        ...
        builders.put(ApiKeys.LIST_PARTITION_REASSIGNMENTS, VendoredKafkaProxyExceptionMapperParityTest::listPartitionReassignmentsInput);
        builders.put(ApiKeys.OFFSET_COMMIT, VendoredKafkaProxyExceptionMapperParityTest::offsetCommitInput);
        ...
        builders.put(ApiKeys.PRODUCE, VendoredKafkaProxyExceptionMapperParityTest::produceInput);
        builders.put(ApiKeys.FETCH, VendoredKafkaProxyExceptionMapperParityTest::fetchInput);
        builders.put(ApiKeys.OFFSET_FETCH, VendoredKafkaProxyExceptionMapperParityTest::offsetFetchInput);
        ...
        builders.put(ApiKeys.LIST_OFFSETS, VendoredKafkaProxyExceptionMapperParityTest::listOffsetsInput);
        ...
        builders.put(ApiKeys.DESCRIBE_ACLS, VendoredKafkaProxyExceptionMapperParityTest::describeAclsInput);
        builders.put(ApiKeys.ELECT_LEADERS, VendoredKafkaProxyExceptionMapperParityTest::electLeadersInput);
        ...
        builders.put(ApiKeys.ADD_PARTITIONS_TO_TXN, VendoredKafkaProxyExceptionMapperParityTest::addPartitionsToTxnInput);
        builders.put(ApiKeys.DELETE_RECORDS, VendoredKafkaProxyExceptionMapperParityTest::deleteRecordsInput);
        ...
        builders.put(ApiKeys.OFFSET_FOR_LEADER_EPOCH, VendoredKafkaProxyExceptionMapperParityTest::offsetForLeaderEpochInput);
        ...
        builders.put(ApiKeys.TXN_OFFSET_COMMIT, VendoredKafkaProxyExceptionMapperParityTest::txnOffsetCommitInput);
        builders.put(ApiKeys.WRITE_TXN_MARKERS, VendoredKafkaProxyExceptionMapperParityTest::writeTxnMarkersInput);
    ...
    // A single partition per topic sidesteps HashMap-iteration-order divergence between the vendored and
    // kafka-clients TopicPartition types inside the real getErrorResponse()/mapper grouping logic — response
    // ordering isn't part of the protocol contract for this RPC, so it isn't worth asserting on.
