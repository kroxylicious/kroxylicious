...
class AzureKeyVaultEdekSerde implements Serde<AzureKeyVaultEdek> {
    ...
    private static final byte HEX_VERSION_0 = (byte) 0;
    private static final byte STRING_VERSION_0 = (byte) 1;
    ...
    public AzureKeyVaultEdek deserialize(ByteBuffer buffer) {
        ...
        if (versionByte == HEX_VERSION_0) {
            return deserializeHexVersion0(buffer);
        }
        else if (versionByte == STRING_VERSION_0) {
