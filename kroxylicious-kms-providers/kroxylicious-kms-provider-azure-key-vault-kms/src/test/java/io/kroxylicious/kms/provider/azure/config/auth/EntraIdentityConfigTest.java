...
class EntraIdentityConfigTest {
    ...
    void minimumAuthConfiguration() {
        ...
        assertThat(entraIdentityConfig.getOauthEndpointOrDefault()).isEqualTo("https://login.microsoftonline.com");
        assertThat(entraIdentityConfig.getAuthScope()).isEqualTo("https://vault.azure.net/.default");
    ...
    void overrideOauthEndpoint() {
        EntraIdentityConfig entraIdentityConfig = new EntraIdentityConfig("http://override.com", TENANT_ID, new InlinePassword(CLIENT_ID),
                new InlinePassword(CLIENT_SECRET), null, null);
        assertThat(entraIdentityConfig.getOauthEndpointOrDefault()).isEqualTo("http://override.com");
    }
    ...
    void overrideScope() {
        EntraIdentityConfig entraIdentityConfig = new EntraIdentityConfig(null, TENANT_ID, new InlinePassword(CLIENT_ID), new InlinePassword(CLIENT_SECRET),
                "http://override.com/.default", null);
        assertThat(entraIdentityConfig.getAuthScope()).isEqualTo("http://override.com/.default");
    }
}
