...
class AzureKeyVaultKmsServiceTest {
    ...
    public void wholeLifeCycle() {
        try (AzureKeyVaultKmsService service = new AzureKeyVaultKmsService()) {
            ...
            service.initialize(new AzureKeyVaultConfig(entraIdentity, "https://my-vault", null));
    ...
    @Test
    public void buildWithoutInitialize() {
        try (AzureKeyVaultKmsService service = new AzureKeyVaultKmsService()) {
    ...
    @Test
    public void getConfigWithoutInitialize() {
        try (AzureKeyVaultKmsService service = new AzureKeyVaultKmsService()) {
