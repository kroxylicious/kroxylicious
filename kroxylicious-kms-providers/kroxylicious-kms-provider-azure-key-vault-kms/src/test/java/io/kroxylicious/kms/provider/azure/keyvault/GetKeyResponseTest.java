...
class GetKeyResponseTest {
     ...
     */
    @Test
    public void deserializeComprehensiveResponse() throws JsonProcessingException {
        var response = """
                {
                  "key": {
    ...
    @CsvSource({ "oct,AES", "oct-HSM,AES", "RSA,RSA", "RSA-HSM,RSA" })
    @ParameterizedTest
    public void supportedKeyType(String keyType, SupportedKeyType expected) throws JsonProcessingException {
        var response = """
                {
                  "key": {
                    "kid": "https://myvault.vault.azure.net/keys/CreateSoftKeyTest/78deebed173b48e48f55abf87ed4cf71",
        ...
        GetKeyResponse getKeyResponse = new ObjectMapper().readValue(response, GetKeyResponse.class);
        assertThat(getKeyResponse).isNotNull();
        assertThat(getKeyResponse.supportedKeyType()).contains(expected);
    }

    @CsvSource({ "EC", "EC-HSM", "funky-new-keytype-of-the-future" })
    @ParameterizedTest
    public void unsupportedKeyTypes(String keyType) throws JsonProcessingException {
        var response = """
                {
                  "key": {
                    "kid": "https://myvault.vault.azure.net/keys/CreateSoftKeyTest/78deebed173b48e48f55abf87ed4cf71",
        ...
        GetKeyResponse getKeyResponse = new ObjectMapper().readValue(response, GetKeyResponse.class);
        assertThat(getKeyResponse).isNotNull();
        assertThat(getKeyResponse.supportedKeyType()).isEmpty();
    }
    ...
    @Test
    public void attributesRequired() {
        var response = """
                {
                  "key": {
                    "kid": "https://myvault.vault.azure.net/keys/CreateSoftKeyTest/78deebed173b48e48f55abf87ed4cf71",
