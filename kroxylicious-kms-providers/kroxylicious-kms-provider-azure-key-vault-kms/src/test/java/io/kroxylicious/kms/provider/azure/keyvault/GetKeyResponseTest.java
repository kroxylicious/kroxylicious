...
class GetKeyResponseTest {
    ...
    @ParameterizedTest
    void supportedKeyType(String keyType, SupportedKeyType expected) throws JsonProcessingException {
        var response = """
                {
                  "key": {
                    "kid": "https://myvault.vault.azure.net/keys/CreateSoftKeyTest/78deebed173b48e48f55abf87ed4cf71",
    ...
    @ParameterizedTest
    void unsupportedKeyTypes(String keyType) throws JsonProcessingException {
        var response = """
                {
                  "key": {
                    "kid": "https://myvault.vault.azure.net/keys/CreateSoftKeyTest/78deebed173b48e48f55abf87ed4cf71",
