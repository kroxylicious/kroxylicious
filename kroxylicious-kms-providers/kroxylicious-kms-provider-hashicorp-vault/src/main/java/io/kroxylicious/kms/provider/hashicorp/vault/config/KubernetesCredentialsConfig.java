...
public record KubernetesCredentialsConfig(
    ...
    /**
     * Deprecated alias for DEFAULT_SERVICE_ACCOUNT_TOKEN_FILE.
     */
    @Deprecated(since = "0.25.0", forRemoval = true)
    public static final String DEFAULT_SERVICE_ACCOUNT_TOKEN_PATH = DEFAULT_SERVICE_ACCOUNT_TOKEN_FILE;
