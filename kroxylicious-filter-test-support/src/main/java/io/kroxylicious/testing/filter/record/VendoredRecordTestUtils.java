 ...
 */
public class VendoredRecordTestUtils {
    ...
    private VendoredRecordTestUtils() {
    }
    ...
    public static String asHex(ByteBuffer buffer) {
        return HexFormat.of().formatHex(VendoredRecordTestUtils.bytesOf(buffer));
    }
     ...
     * @see VendoredRecordTestUtils#singleElementRecordBatch(long, String, String, Header[])
     */
     ...
     * @param offset baseOffset of the single batch and offset of the single record within it
     * @return The batch
     * @see VendoredRecordTestUtils#memoryRecordsWithAllRecordsRemoved(long)
     */
