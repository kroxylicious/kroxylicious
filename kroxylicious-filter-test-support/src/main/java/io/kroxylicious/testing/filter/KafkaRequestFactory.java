 ...
 */
public class KafkaRequestFactory {
    ...
    static {
        messagePopulators.put(ApiKeys.PRODUCE, KafkaRequestFactory::populateProduceRequest);
        messagePopulators.put(ApiKeys.LIST_OFFSETS, KafkaRequestFactory::populateListOffsetsRequest);
        messagePopulators.put(ApiKeys.OFFSET_FETCH, KafkaRequestFactory::populateOffsetFetchRequest);
        messagePopulators.put(ApiKeys.METADATA, KafkaRequestFactory::populateMetadataRequest);
        messagePopulators.put(ApiKeys.LEAVE_GROUP, KafkaRequestFactory::populateLeaveGroupRequest);
        messagePopulators.put(ApiKeys.DESCRIBE_GROUPS, KafkaRequestFactory::populateDescribeGroupsRequest);
        messagePopulators.put(ApiKeys.CONSUMER_GROUP_DESCRIBE, KafkaRequestFactory::populateConsumeGroupDescribeRequest);
        messagePopulators.put(ApiKeys.DELETE_GROUPS, KafkaRequestFactory::populateDeleteGroupRequest);
        messagePopulators.put(ApiKeys.OFFSET_COMMIT, KafkaRequestFactory::populateOffsetCommitRequest);
        messagePopulators.put(ApiKeys.CREATE_TOPICS, KafkaRequestFactory::populateCreateTopicsRequest);
        messagePopulators.put(ApiKeys.DELETE_TOPICS, KafkaRequestFactory::populateDeleteTopicsRequest);
        messagePopulators.put(ApiKeys.DELETE_RECORDS, KafkaRequestFactory::populateDeleteRecordsRequest);
        messagePopulators.put(ApiKeys.INIT_PRODUCER_ID, KafkaRequestFactory::populateInitProducerIdRequest);
        messagePopulators.put(ApiKeys.CREATE_ACLS, KafkaRequestFactory::populateCreateAclsRequest);
        messagePopulators.put(ApiKeys.DESCRIBE_ACLS, KafkaRequestFactory::populateDescribeAclsRequest);
        messagePopulators.put(ApiKeys.DELETE_ACLS, KafkaRequestFactory::populateDeleteAclsRequest);
        messagePopulators.put(ApiKeys.OFFSET_FOR_LEADER_EPOCH, KafkaRequestFactory::populateOffsetForLeaderEpochRequest);
        messagePopulators.put(ApiKeys.SHARE_GROUP_DESCRIBE, KafkaRequestFactory::populateShareGroupDescribeRequest);
        messagePopulators.put(ApiKeys.INITIALIZE_SHARE_GROUP_STATE, KafkaRequestFactory::populateInitializeShareGroupStateRequest);
        messagePopulators.put(ApiKeys.READ_SHARE_GROUP_STATE, KafkaRequestFactory::populateReadShareGroupStateRequest);
        messagePopulators.put(ApiKeys.WRITE_SHARE_GROUP_STATE, KafkaRequestFactory::populateWriteShareGroupStateRequest);
        messagePopulators.put(ApiKeys.DELETE_SHARE_GROUP_STATE, KafkaRequestFactory::populateDeleteShareGroupStateRequest);
        messagePopulators.put(ApiKeys.READ_SHARE_GROUP_STATE_SUMMARY, KafkaRequestFactory::populateReadShareGroupStateSummaryRequest);
        messagePopulators.put(ApiKeys.STREAMS_GROUP_DESCRIBE, KafkaRequestFactory::populateStreamsGroupDescribeRequest);
        messagePopulators.put(ApiKeys.DESCRIBE_SHARE_GROUP_OFFSETS, KafkaRequestFactory::populateDescribeShareGroupOffsetsRequest);
        messagePopulators.put(ApiKeys.LIST_CONFIG_RESOURCES, KafkaRequestFactory::populateListConfigResourcesRequest);
    }

    private KafkaRequestFactory() {
    }
    ...
    private static void populateProduceRequest(ApiMessage apiMessage, short apiVersion) {
        ...
        produceData.setRecords(KafkaRecordTestUtils.memoryRecords(List.of(KafkaRecordTestUtils.record(MobyNamesGenerator.getRandomName()))));
