 ...
 */
public class KafkaApiMessageCondition<X extends ApiMessage> extends Condition<X> {
     ...
     */
    public KafkaApiMessageCondition(Predicate<X> xPredicate, Description description) {
        super(description);
     ...
     */
    public static <X extends ApiMessage> KafkaApiMessageCondition<X> forApiKey(short expectedApiKey) {
        return new KafkaApiMessageCondition<>(apiMessage -> apiMessage.apiKey() == expectedApiKey,
     ...
     * @return the condition
     */
    public static <X extends ApiMessage> KafkaApiMessageCondition<X> forApiKey(ApiKeys expectedApiKey) {
        return new KafkaApiMessageCondition<>(apiMessage -> ApiKeys.forId(apiMessage.apiKey()) == expectedApiKey,
     ...
     */
    public KafkaApiMessageCondition(Predicate<X> predicate) {
