 ...
 */
public class KafkaRecordTestUtils {
    ...
    public static String asHex(ByteBuffer buffer) {
        return HexFormat.of().formatHex(KafkaRecordTestUtils.bytesOf(buffer));
    }
     ...
     * @see KafkaRecordTestUtils#singleElementRecordBatch(long, String, String, Header[])
     */
     ...
     * @param offset baseOffset of the single batch and offset of the single record within it
     * @return The batch
     * @see KafkaRecordTestUtils#memoryRecordsWithAllRecordsRemoved(long)
     */
