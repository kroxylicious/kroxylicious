 ...
 */
public class VendoredApiMessageCondition<X extends ApiMessage> extends Condition<X> {
     ...
     */
    public VendoredApiMessageCondition(Predicate<X> xPredicate, Description description) {
        super(description);
     ...
     */
    public static <X extends ApiMessage> VendoredApiMessageCondition<X> forApiKey(short expectedApiKey) {
        return new VendoredApiMessageCondition<>(apiMessage -> apiMessage.apiKey() == expectedApiKey,
     ...
     * @return the condition
     */
    public static <X extends ApiMessage> VendoredApiMessageCondition<X> forApiKey(ApiKeys expectedApiKey) {
        return new VendoredApiMessageCondition<>(apiMessage -> ApiKeys.forId(apiMessage.apiKey()) == expectedApiKey,
     ...
     */
    public VendoredApiMessageCondition(Predicate<X> predicate) {
