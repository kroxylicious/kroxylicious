...
class KafkaHeadersAssertTest {

    KafkaHeadersAssert headersAssert = KafkaHeadersAssert.assertThat(new RecordHeaders()
    ...
    private final KafkaHeadersAssert emptyAssert = KafkaHeadersAssert.assertThat(new RecordHeaders());
    KafkaHeadersAssert singletonAssert = KafkaHeadersAssert.assertThat(new RecordHeaders()
            .add("foo", null));
    ...
    @Test
    void nullHeaders() {
        KafkaHeadersAssert nullAssert = KafkaHeadersAssert.assertThat(null);
        nullAssert.isNull();
