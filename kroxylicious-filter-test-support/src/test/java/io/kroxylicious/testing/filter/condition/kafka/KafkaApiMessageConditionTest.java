...
class KafkaApiMessageConditionTest {
    ...
    void shouldReturnFalseIfActualIsNull() {
        // Given
        KafkaApiMessageCondition<ProduceRequestData> apiMessageCondition = new KafkaApiMessageCondition<>(o -> true);
    ...
    void shouldReturnPredicateResultFalse() {
        // Given
        KafkaApiMessageCondition<ProduceRequestData> apiMessageCondition = new KafkaApiMessageCondition<>(o -> false);
    ...
    void shouldCreateConditionForApiKeyEnum(ApiKeys apiKey) {
        // Given
        KafkaApiMessageCondition<ApiMessage> apiMessageCondition = KafkaApiMessageCondition.forApiKey(apiKey);
    ...
    void shouldCreateConditionForApiKeyShort(ApiKeys apiKey) {
        // Given
        KafkaApiMessageCondition<ApiMessage> apiMessageCondition = KafkaApiMessageCondition.forApiKey(apiKey.id);
