...
class VendoredApiMessageConditionTest {
    ...
    void shouldReturnFalseIfActualIsNull() {
        // Given
        VendoredApiMessageCondition<ProduceRequestData> apiMessageCondition = new VendoredApiMessageCondition<>(o -> true);
    ...
    void shouldReturnPredicateResultFalse() {
        // Given
        VendoredApiMessageCondition<ProduceRequestData> apiMessageCondition = new VendoredApiMessageCondition<>(o -> false);
    ...
    void shouldCreateConditionForApiKeyEnum(ApiKeys apiKey) {
        // Given
        VendoredApiMessageCondition<ApiMessage> apiMessageCondition = VendoredApiMessageCondition.forApiKey(apiKey);
    ...
    void shouldCreateConditionForApiKeyShort(ApiKeys apiKey) {
        // Given
        VendoredApiMessageCondition<ApiMessage> apiMessageCondition = VendoredApiMessageCondition.forApiKey(apiKey.id);
