 ...
 */
public interface ControlledShutdownRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onControlledShutdownRequest(ControlledShutdownRequestData request, KrpcFilterContext context);
