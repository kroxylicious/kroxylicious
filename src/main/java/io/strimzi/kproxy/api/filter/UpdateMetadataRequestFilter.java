 ...
 */
public interface UpdateMetadataRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onUpdateMetadataRequest(UpdateMetadataRequestData request, KrpcFilterContext context);
