 ...
 */
public interface OffsetCommitResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetCommitResponse(OffsetCommitResponseData response, KrpcFilterContext context);
