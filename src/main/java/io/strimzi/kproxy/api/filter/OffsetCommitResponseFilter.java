 ...
 */
public interface OffsetCommitResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetCommitResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetCommitResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetCommitResponseData onOffsetCommitResponse(OffsetCommitResponseData data, FilterContext context);
}