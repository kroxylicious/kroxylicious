 ...
 */
public interface ApiVersionsResponseFilter extends KrpcResponseFilter {
    /**
     * Handle the given {@code response},
     * returning the {@code ApiVersionsResponseData} instance to be passed to the next filter.
     ...
     */
    public KrpcFilterState onApiVersionsResponse(ApiVersionsResponseData response, KrpcFilterContext context);
