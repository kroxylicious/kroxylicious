 ...
 */
public interface ControlledShutdownResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onControlledShutdownResponse(ControlledShutdownResponseData response, KrpcFilterContext context);
