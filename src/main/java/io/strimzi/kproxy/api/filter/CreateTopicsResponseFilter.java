 ...
 */
public interface CreateTopicsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code CreateTopicsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code CreateTopicsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public CreateTopicsResponseData onCreateTopicsResponse(CreateTopicsResponseData data, FilterContext context);
}