 ...
 */
public interface HeartbeatRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onHeartbeatRequest(HeartbeatRequestData request, KrpcFilterContext context);
