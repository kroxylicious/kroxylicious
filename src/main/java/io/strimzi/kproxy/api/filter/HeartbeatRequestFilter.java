 ...
 */
public interface HeartbeatRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code HeartbeatRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code HeartbeatRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public HeartbeatRequestData onHeartbeatRequest(HeartbeatRequestData data, FilterContext context);
}