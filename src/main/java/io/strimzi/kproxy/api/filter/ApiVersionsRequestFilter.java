 ...
 */
public interface ApiVersionsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ApiVersionsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ApiVersionsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ApiVersionsRequestData onApiVersionsRequest(ApiVersionsRequestData data, FilterContext context);
}