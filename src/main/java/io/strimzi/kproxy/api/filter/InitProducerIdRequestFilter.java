 ...
 */
public interface InitProducerIdRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onInitProducerIdRequest(InitProducerIdRequestData request, KrpcFilterContext context);
