 ...
 */
public interface InitProducerIdRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code InitProducerIdRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code InitProducerIdRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public InitProducerIdRequestData onInitProducerIdRequest(InitProducerIdRequestData data, FilterContext context);
}