 ...
 */
public interface AllocateProducerIdsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAllocateProducerIdsRequest(AllocateProducerIdsRequestData request, KrpcFilterContext context);
