 ...
 */
public interface AllocateProducerIdsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AllocateProducerIdsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AllocateProducerIdsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AllocateProducerIdsRequestData onAllocateProducerIdsRequest(AllocateProducerIdsRequestData data, FilterContext context);
}