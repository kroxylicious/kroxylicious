 ...
 */
public interface EndQuorumEpochResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EndQuorumEpochResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code EndQuorumEpochResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EndQuorumEpochResponseData onEndQuorumEpochResponse(EndQuorumEpochResponseData data, FilterContext context);
}