 ...
 */
public interface EndQuorumEpochResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onEndQuorumEpochResponse(EndQuorumEpochResponseData response, KrpcFilterContext context);
