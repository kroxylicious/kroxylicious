 ...
 */
public interface DescribeUserScramCredentialsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeUserScramCredentialsResponse(DescribeUserScramCredentialsResponseData response, KrpcFilterContext context);
