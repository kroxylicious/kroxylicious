 ...
 */
public interface EnvelopeRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EnvelopeRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code EnvelopeRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EnvelopeRequestData onEnvelopeRequest(EnvelopeRequestData data, FilterContext context);
}