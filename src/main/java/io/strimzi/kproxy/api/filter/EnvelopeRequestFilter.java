 ...
 */
public interface EnvelopeRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onEnvelopeRequest(EnvelopeRequestData request, KrpcFilterContext context);
