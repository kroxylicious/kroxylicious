 ...
 */
public interface DeleteTopicsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteTopicsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteTopicsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteTopicsResponseData onDeleteTopicsResponse(DeleteTopicsResponseData data, FilterContext context);
}