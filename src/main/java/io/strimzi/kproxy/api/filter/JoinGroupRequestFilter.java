 ...
 */
public interface JoinGroupRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code JoinGroupRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code JoinGroupRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public JoinGroupRequestData onJoinGroupRequest(JoinGroupRequestData data, FilterContext context);
}