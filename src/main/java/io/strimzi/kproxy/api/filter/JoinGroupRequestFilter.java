 ...
 */
public interface JoinGroupRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onJoinGroupRequest(JoinGroupRequestData request, KrpcFilterContext context);
