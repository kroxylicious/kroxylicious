 ...
 */
public interface HeartbeatResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onHeartbeatResponse(HeartbeatResponseData response, KrpcFilterContext context);
