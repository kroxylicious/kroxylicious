 ...
 */
public interface JoinGroupResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onJoinGroupResponse(JoinGroupResponseData response, KrpcFilterContext context);
