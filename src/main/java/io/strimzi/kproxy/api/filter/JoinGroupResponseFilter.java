 ...
 */
public interface JoinGroupResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code JoinGroupResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code JoinGroupResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public JoinGroupResponseData onJoinGroupResponse(JoinGroupResponseData data, FilterContext context);
}