 ...
 */
public interface UpdateFeaturesResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onUpdateFeaturesResponse(UpdateFeaturesResponseData response, KrpcFilterContext context);
