 ...
 */
public interface UpdateFeaturesResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code UpdateFeaturesResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code UpdateFeaturesResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public UpdateFeaturesResponseData onUpdateFeaturesResponse(UpdateFeaturesResponseData data, FilterContext context);
}