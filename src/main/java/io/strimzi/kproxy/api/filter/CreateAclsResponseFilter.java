 ...
 */
public interface CreateAclsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code CreateAclsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code CreateAclsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public CreateAclsResponseData onCreateAclsResponse(CreateAclsResponseData data, FilterContext context);
}