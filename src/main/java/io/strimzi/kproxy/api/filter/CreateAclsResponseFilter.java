 ...
 */
public interface CreateAclsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onCreateAclsResponse(CreateAclsResponseData response, KrpcFilterContext context);
