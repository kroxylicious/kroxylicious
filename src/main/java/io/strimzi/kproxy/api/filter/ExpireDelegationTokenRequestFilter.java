 ...
 */
public interface ExpireDelegationTokenRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onExpireDelegationTokenRequest(ExpireDelegationTokenRequestData request, KrpcFilterContext context);
