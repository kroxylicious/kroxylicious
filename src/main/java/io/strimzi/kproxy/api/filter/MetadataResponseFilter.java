 ...
 */
public interface MetadataResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code MetadataResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code MetadataResponseData} instance to be passed to the next filter.
