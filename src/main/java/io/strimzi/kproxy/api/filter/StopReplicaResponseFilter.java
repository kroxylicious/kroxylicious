 ...
 */
public interface StopReplicaResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onStopReplicaResponse(StopReplicaResponseData response, KrpcFilterContext context);
