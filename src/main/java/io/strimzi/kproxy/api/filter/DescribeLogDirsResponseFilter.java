 ...
 */
public interface DescribeLogDirsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeLogDirsResponse(DescribeLogDirsResponseData response, KrpcFilterContext context);
