 ...
 */
public interface DescribeLogDirsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeLogDirsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeLogDirsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeLogDirsResponseData onDescribeLogDirsResponse(DescribeLogDirsResponseData data, FilterContext context);
}