 ...
 */
public interface LeaderAndIsrResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onLeaderAndIsrResponse(LeaderAndIsrResponseData response, KrpcFilterContext context);
