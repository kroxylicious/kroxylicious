 ...
 */
public interface EndTxnRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onEndTxnRequest(EndTxnRequestData request, KrpcFilterContext context);
