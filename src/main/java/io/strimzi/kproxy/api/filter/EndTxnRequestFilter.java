 ...
 */
public interface EndTxnRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EndTxnRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code EndTxnRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EndTxnRequestData onEndTxnRequest(EndTxnRequestData data, FilterContext context);
}