 ...
 */
public interface DescribeConfigsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeConfigsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeConfigsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeConfigsRequestData onDescribeConfigsRequest(DescribeConfigsRequestData data, FilterContext context);
}