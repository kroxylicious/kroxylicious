 ...
 */
public interface DescribeConfigsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeConfigsRequest(DescribeConfigsRequestData request, KrpcFilterContext context);
