 ...
 */
public interface EndQuorumEpochRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onEndQuorumEpochRequest(EndQuorumEpochRequestData request, KrpcFilterContext context);
