 ...
 */
public interface EndQuorumEpochRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EndQuorumEpochRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code EndQuorumEpochRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EndQuorumEpochRequestData onEndQuorumEpochRequest(EndQuorumEpochRequestData data, FilterContext context);
}