 ...
 */
public interface VoteRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code VoteRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code VoteRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public VoteRequestData onVoteRequest(VoteRequestData data, FilterContext context);
}