...
/**
 * A stateless filter for RequestHeaders.
...
public interface RequestHeaderFilter {
     ...
     * returning the {@code RequestHeaderData} instance to be passed to the next filter.
     ...
     * @return the {@code RequestHeaderData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public RequestHeaderData onRequestHeader(RequestHeaderData data, FilterContext context);
}