 ...
 */
public interface BrokerHeartbeatResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code BrokerHeartbeatResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code BrokerHeartbeatResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public BrokerHeartbeatResponseData onBrokerHeartbeatResponse(BrokerHeartbeatResponseData data, FilterContext context);
}