 ...
 */
public interface BrokerHeartbeatResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onBrokerHeartbeatResponse(BrokerHeartbeatResponseData response, KrpcFilterContext context);
