 ...
 */
public interface DescribeTransactionsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeTransactionsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeTransactionsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeTransactionsRequestData onDescribeTransactionsRequest(DescribeTransactionsRequestData data, FilterContext context);
}