 ...
 */
public interface DescribeTransactionsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeTransactionsRequest(DescribeTransactionsRequestData request, KrpcFilterContext context);
