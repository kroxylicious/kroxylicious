 ...
 */
public interface DescribeUserScramCredentialsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeUserScramCredentialsRequest(DescribeUserScramCredentialsRequestData request, KrpcFilterContext context);
