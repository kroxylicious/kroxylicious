...
/**
 * A stateless filter for ResponseHeaders.
...
public interface ResponseHeaderFilter {
     ...
     * returning the {@code ResponseHeaderData} instance to be passed to the next filter.
     ...
     * @return the {@code ResponseHeaderData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ResponseHeaderData onResponseHeader(ResponseHeaderData data, FilterContext context);
}