 ...
 */
public interface BrokerRegistrationRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onBrokerRegistrationRequest(BrokerRegistrationRequestData request, KrpcFilterContext context);
