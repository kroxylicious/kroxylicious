 ...
 */
public interface BrokerRegistrationRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code BrokerRegistrationRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code BrokerRegistrationRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public BrokerRegistrationRequestData onBrokerRegistrationRequest(BrokerRegistrationRequestData data, FilterContext context);
}