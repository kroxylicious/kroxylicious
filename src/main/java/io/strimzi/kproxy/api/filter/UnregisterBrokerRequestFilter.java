 ...
 */
public interface UnregisterBrokerRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onUnregisterBrokerRequest(UnregisterBrokerRequestData request, KrpcFilterContext context);
