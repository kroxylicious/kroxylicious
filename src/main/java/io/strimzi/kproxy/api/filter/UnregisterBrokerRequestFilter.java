 ...
 */
public interface UnregisterBrokerRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code UnregisterBrokerRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code UnregisterBrokerRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public UnregisterBrokerRequestData onUnregisterBrokerRequest(UnregisterBrokerRequestData data, FilterContext context);
}