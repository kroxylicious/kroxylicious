 ...
 */
public interface CreateDelegationTokenResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onCreateDelegationTokenResponse(CreateDelegationTokenResponseData response, KrpcFilterContext context);
