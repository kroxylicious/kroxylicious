 ...
 */
public interface DescribeTransactionsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeTransactionsResponse(DescribeTransactionsResponseData response, KrpcFilterContext context);
