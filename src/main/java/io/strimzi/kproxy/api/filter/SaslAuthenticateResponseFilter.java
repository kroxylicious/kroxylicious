 ...
 */
public interface SaslAuthenticateResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code SaslAuthenticateResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code SaslAuthenticateResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public SaslAuthenticateResponseData onSaslAuthenticateResponse(SaslAuthenticateResponseData data, FilterContext context);
}