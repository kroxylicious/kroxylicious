 ...
 */
public interface SaslAuthenticateResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onSaslAuthenticateResponse(SaslAuthenticateResponseData response, KrpcFilterContext context);
