 ...
 */
public interface OffsetFetchRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetFetchRequest(OffsetFetchRequestData request, KrpcFilterContext context);
