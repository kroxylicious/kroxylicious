 ...
 */
public interface OffsetFetchRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetFetchRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetFetchRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetFetchRequestData onOffsetFetchRequest(OffsetFetchRequestData data, FilterContext context);
}