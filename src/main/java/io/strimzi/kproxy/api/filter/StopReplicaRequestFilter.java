 ...
 */
public interface StopReplicaRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onStopReplicaRequest(StopReplicaRequestData request, KrpcFilterContext context);
