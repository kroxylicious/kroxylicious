 ...
 */
public interface DescribeQuorumRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeQuorumRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeQuorumRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeQuorumRequestData onDescribeQuorumRequest(DescribeQuorumRequestData data, FilterContext context);
}