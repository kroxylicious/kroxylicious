 ...
 */
public interface DescribeQuorumRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeQuorumRequest(DescribeQuorumRequestData request, KrpcFilterContext context);
