 ...
 */
public interface AlterConfigsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterConfigsRequest(AlterConfigsRequestData request, KrpcFilterContext context);
