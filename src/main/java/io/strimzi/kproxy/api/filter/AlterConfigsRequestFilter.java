 ...
 */
public interface AlterConfigsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterConfigsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterConfigsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterConfigsRequestData onAlterConfigsRequest(AlterConfigsRequestData data, FilterContext context);
}