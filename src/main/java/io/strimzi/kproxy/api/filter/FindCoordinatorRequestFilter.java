 ...
 */
public interface FindCoordinatorRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code FindCoordinatorRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code FindCoordinatorRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public FindCoordinatorRequestData onFindCoordinatorRequest(FindCoordinatorRequestData data, FilterContext context);
}