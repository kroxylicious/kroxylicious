 ...
 */
public interface FindCoordinatorRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onFindCoordinatorRequest(FindCoordinatorRequestData request, KrpcFilterContext context);
