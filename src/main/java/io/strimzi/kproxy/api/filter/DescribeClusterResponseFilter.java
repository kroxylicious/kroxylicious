 ...
 */
public interface DescribeClusterResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeClusterResponse(DescribeClusterResponseData response, KrpcFilterContext context);
