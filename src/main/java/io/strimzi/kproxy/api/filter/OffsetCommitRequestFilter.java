 ...
 */
public interface OffsetCommitRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetCommitRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetCommitRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetCommitRequestData onOffsetCommitRequest(OffsetCommitRequestData data, FilterContext context);
}