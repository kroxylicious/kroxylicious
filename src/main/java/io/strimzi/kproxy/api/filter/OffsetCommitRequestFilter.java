 ...
 */
public interface OffsetCommitRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetCommitRequest(OffsetCommitRequestData request, KrpcFilterContext context);
