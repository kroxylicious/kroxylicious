 ...
 */
public interface CreateTopicsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onCreateTopicsRequest(CreateTopicsRequestData request, KrpcFilterContext context);
