 ...
 */
public interface CreateTopicsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code CreateTopicsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code CreateTopicsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public CreateTopicsRequestData onCreateTopicsRequest(CreateTopicsRequestData data, FilterContext context);
}