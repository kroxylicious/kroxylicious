 ...
 */
public interface AlterConfigsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterConfigsResponse(AlterConfigsResponseData response, KrpcFilterContext context);
