 ...
 */
public interface AlterConfigsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterConfigsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterConfigsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterConfigsResponseData onAlterConfigsResponse(AlterConfigsResponseData data, FilterContext context);
}