 ...
 */
public interface SaslHandshakeRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onSaslHandshakeRequest(SaslHandshakeRequestData request, KrpcFilterContext context);
