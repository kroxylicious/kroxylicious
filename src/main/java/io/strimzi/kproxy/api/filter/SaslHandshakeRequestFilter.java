 ...
 */
public interface SaslHandshakeRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code SaslHandshakeRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code SaslHandshakeRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public SaslHandshakeRequestData onSaslHandshakeRequest(SaslHandshakeRequestData data, FilterContext context);
}