 ...
 */
public interface DeleteRecordsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteRecordsRequest(DeleteRecordsRequestData request, KrpcFilterContext context);
