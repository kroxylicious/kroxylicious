 ...
 */
public interface SaslHandshakeResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onSaslHandshakeResponse(SaslHandshakeResponseData response, KrpcFilterContext context);
