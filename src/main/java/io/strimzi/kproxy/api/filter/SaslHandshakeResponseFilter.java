 ...
 */
public interface SaslHandshakeResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code SaslHandshakeResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code SaslHandshakeResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public SaslHandshakeResponseData onSaslHandshakeResponse(SaslHandshakeResponseData data, FilterContext context);
}