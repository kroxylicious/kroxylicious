 ...
 */
public interface MetadataRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onMetadataRequest(MetadataRequestData request, KrpcFilterContext context);
