 ...
 */
public interface MetadataRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code MetadataRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code MetadataRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public MetadataRequestData onMetadataRequest(MetadataRequestData data, FilterContext context);
}