 ...
 */
public interface IncrementalAlterConfigsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onIncrementalAlterConfigsResponse(IncrementalAlterConfigsResponseData response, KrpcFilterContext context);
