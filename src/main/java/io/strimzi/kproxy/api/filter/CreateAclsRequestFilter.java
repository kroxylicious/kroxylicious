 ...
 */
public interface CreateAclsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onCreateAclsRequest(CreateAclsRequestData request, KrpcFilterContext context);
