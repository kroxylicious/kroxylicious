 ...
 */
public interface CreateAclsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code CreateAclsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code CreateAclsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public CreateAclsRequestData onCreateAclsRequest(CreateAclsRequestData data, FilterContext context);
}