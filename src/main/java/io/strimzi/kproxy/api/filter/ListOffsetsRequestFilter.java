 ...
 */
public interface ListOffsetsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onListOffsetsRequest(ListOffsetsRequestData request, KrpcFilterContext context);
