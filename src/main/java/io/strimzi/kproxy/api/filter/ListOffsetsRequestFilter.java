 ...
 */
public interface ListOffsetsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListOffsetsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ListOffsetsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListOffsetsRequestData onListOffsetsRequest(ListOffsetsRequestData data, FilterContext context);
}