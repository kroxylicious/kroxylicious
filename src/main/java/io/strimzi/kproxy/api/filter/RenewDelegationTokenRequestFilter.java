 ...
 */
public interface RenewDelegationTokenRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code RenewDelegationTokenRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code RenewDelegationTokenRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public RenewDelegationTokenRequestData onRenewDelegationTokenRequest(RenewDelegationTokenRequestData data, FilterContext context);
}