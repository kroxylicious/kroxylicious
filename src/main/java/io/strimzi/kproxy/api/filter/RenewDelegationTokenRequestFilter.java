 ...
 */
public interface RenewDelegationTokenRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onRenewDelegationTokenRequest(RenewDelegationTokenRequestData request, KrpcFilterContext context);
