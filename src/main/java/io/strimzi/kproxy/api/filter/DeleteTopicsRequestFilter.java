 ...
 */
public interface DeleteTopicsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteTopicsRequest(DeleteTopicsRequestData request, KrpcFilterContext context);
