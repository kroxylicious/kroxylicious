 ...
 */
public interface ListTransactionsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onListTransactionsResponse(ListTransactionsResponseData response, KrpcFilterContext context);
