 ...
 */
public interface ListTransactionsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListTransactionsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code ListTransactionsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListTransactionsResponseData onListTransactionsResponse(ListTransactionsResponseData data, FilterContext context);
}