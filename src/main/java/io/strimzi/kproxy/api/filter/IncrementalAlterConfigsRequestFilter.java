 ...
 */
public interface IncrementalAlterConfigsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onIncrementalAlterConfigsRequest(IncrementalAlterConfigsRequestData request, KrpcFilterContext context);
