 ...
 */
public interface DescribeProducersResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeProducersResponse(DescribeProducersResponseData response, KrpcFilterContext context);
