 ...
 */
public interface DescribeProducersResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeProducersResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeProducersResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeProducersResponseData onDescribeProducersResponse(DescribeProducersResponseData data, FilterContext context);
}