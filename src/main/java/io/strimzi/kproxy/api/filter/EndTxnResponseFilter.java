 ...
 */
public interface EndTxnResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onEndTxnResponse(EndTxnResponseData response, KrpcFilterContext context);
