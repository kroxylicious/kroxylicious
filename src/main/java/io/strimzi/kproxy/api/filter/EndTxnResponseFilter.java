 ...
 */
public interface EndTxnResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EndTxnResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code EndTxnResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EndTxnResponseData onEndTxnResponse(EndTxnResponseData data, FilterContext context);
}