 ...
 */
public interface InitProducerIdResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onInitProducerIdResponse(InitProducerIdResponseData response, KrpcFilterContext context);
