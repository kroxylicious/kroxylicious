 ...
 */
public interface InitProducerIdResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code InitProducerIdResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code InitProducerIdResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public InitProducerIdResponseData onInitProducerIdResponse(InitProducerIdResponseData data, FilterContext context);
}