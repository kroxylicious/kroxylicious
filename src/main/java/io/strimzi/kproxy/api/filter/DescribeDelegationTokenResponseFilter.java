 ...
 */
public interface DescribeDelegationTokenResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeDelegationTokenResponse(DescribeDelegationTokenResponseData response, KrpcFilterContext context);
