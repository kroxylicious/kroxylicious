 ...
 */
public interface DescribeDelegationTokenResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeDelegationTokenResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeDelegationTokenResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeDelegationTokenResponseData onDescribeDelegationTokenResponse(DescribeDelegationTokenResponseData data, FilterContext context);
}