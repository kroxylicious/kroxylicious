 ...
 */
public interface VoteResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code VoteResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code VoteResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public VoteResponseData onVoteResponse(VoteResponseData data, FilterContext context);
}