 ...
 */
public interface VoteResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onVoteResponse(VoteResponseData response, KrpcFilterContext context);
