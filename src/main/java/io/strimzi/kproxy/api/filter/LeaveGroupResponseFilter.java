 ...
 */
public interface LeaveGroupResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onLeaveGroupResponse(LeaveGroupResponseData response, KrpcFilterContext context);
