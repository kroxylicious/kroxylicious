 ...
 */
public interface LeaveGroupResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code LeaveGroupResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code LeaveGroupResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public LeaveGroupResponseData onLeaveGroupResponse(LeaveGroupResponseData data, FilterContext context);
}