 ...
 */
public interface OffsetDeleteResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetDeleteResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetDeleteResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetDeleteResponseData onOffsetDeleteResponse(OffsetDeleteResponseData data, FilterContext context);
}