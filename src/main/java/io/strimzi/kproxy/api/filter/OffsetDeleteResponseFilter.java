 ...
 */
public interface OffsetDeleteResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetDeleteResponse(OffsetDeleteResponseData response, KrpcFilterContext context);
