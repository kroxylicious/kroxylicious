 ...
 */
public interface BeginQuorumEpochResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code BeginQuorumEpochResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code BeginQuorumEpochResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public BeginQuorumEpochResponseData onBeginQuorumEpochResponse(BeginQuorumEpochResponseData data, FilterContext context);
}