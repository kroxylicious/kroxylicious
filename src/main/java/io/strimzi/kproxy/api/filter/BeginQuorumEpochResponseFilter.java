 ...
 */
public interface BeginQuorumEpochResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onBeginQuorumEpochResponse(BeginQuorumEpochResponseData response, KrpcFilterContext context);
