 ...
 */
public interface AlterUserScramCredentialsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterUserScramCredentialsResponse(AlterUserScramCredentialsResponseData response, KrpcFilterContext context);
