 ...
 */
public interface ElectLeadersRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ElectLeadersRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ElectLeadersRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ElectLeadersRequestData onElectLeadersRequest(ElectLeadersRequestData data, FilterContext context);
}