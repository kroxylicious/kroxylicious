 ...
 */
public interface ElectLeadersRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onElectLeadersRequest(ElectLeadersRequestData request, KrpcFilterContext context);
