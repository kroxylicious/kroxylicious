 ...
 */
public interface SaslAuthenticateRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onSaslAuthenticateRequest(SaslAuthenticateRequestData request, KrpcFilterContext context);
