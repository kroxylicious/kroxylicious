 ...
 */
public interface CreatePartitionsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onCreatePartitionsRequest(CreatePartitionsRequestData request, KrpcFilterContext context);
