 ...
 */
public interface CreatePartitionsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code CreatePartitionsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code CreatePartitionsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public CreatePartitionsRequestData onCreatePartitionsRequest(CreatePartitionsRequestData data, FilterContext context);
}