 ...
 */
public interface AlterUserScramCredentialsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterUserScramCredentialsRequest(AlterUserScramCredentialsRequestData request, KrpcFilterContext context);
