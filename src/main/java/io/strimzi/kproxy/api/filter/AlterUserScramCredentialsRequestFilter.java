 ...
 */
public interface AlterUserScramCredentialsRequestFilter {
     ...
     * @return the {@code AlterUserScramCredentialsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterUserScramCredentialsRequestData onAlterUserScramCredentialsRequest(AlterUserScramCredentialsRequestData data, FilterContext context);
}