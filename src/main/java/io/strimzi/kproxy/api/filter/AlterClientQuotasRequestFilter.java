 ...
 */
public interface AlterClientQuotasRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterClientQuotasRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterClientQuotasRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterClientQuotasRequestData onAlterClientQuotasRequest(AlterClientQuotasRequestData data, FilterContext context);
}