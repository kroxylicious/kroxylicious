 ...
 */
public interface AlterClientQuotasRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterClientQuotasRequest(AlterClientQuotasRequestData request, KrpcFilterContext context);
