 ...
 */
public interface OffsetFetchResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetFetchResponse(OffsetFetchResponseData response, KrpcFilterContext context);
