 ...
 */
public interface OffsetFetchResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetFetchResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetFetchResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetFetchResponseData onOffsetFetchResponse(OffsetFetchResponseData data, FilterContext context);
}