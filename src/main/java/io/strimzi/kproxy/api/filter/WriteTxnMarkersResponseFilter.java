 ...
 */
public interface WriteTxnMarkersResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code WriteTxnMarkersResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code WriteTxnMarkersResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public WriteTxnMarkersResponseData onWriteTxnMarkersResponse(WriteTxnMarkersResponseData data, FilterContext context);
}