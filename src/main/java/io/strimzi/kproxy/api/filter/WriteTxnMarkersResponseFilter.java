 ...
 */
public interface WriteTxnMarkersResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onWriteTxnMarkersResponse(WriteTxnMarkersResponseData response, KrpcFilterContext context);
