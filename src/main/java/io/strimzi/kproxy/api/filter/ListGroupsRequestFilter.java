 ...
 */
public interface ListGroupsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListGroupsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ListGroupsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListGroupsRequestData onListGroupsRequest(ListGroupsRequestData data, FilterContext context);
}