 ...
 */
public interface ListGroupsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onListGroupsRequest(ListGroupsRequestData request, KrpcFilterContext context);
