 ...
 */
public interface DeleteRecordsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteRecordsResponse(DeleteRecordsResponseData response, KrpcFilterContext context);
