 ...
 */
public interface DeleteRecordsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteRecordsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteRecordsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteRecordsResponseData onDeleteRecordsResponse(DeleteRecordsResponseData data, FilterContext context);
}