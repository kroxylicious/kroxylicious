 ...
 */
public interface AddOffsetsToTxnRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AddOffsetsToTxnRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AddOffsetsToTxnRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AddOffsetsToTxnRequestData onAddOffsetsToTxnRequest(AddOffsetsToTxnRequestData data, FilterContext context);
}