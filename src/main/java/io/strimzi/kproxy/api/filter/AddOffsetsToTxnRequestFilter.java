 ...
 */
public interface AddOffsetsToTxnRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAddOffsetsToTxnRequest(AddOffsetsToTxnRequestData request, KrpcFilterContext context);
