 ...
 */
public interface TxnOffsetCommitRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onTxnOffsetCommitRequest(TxnOffsetCommitRequestData request, KrpcFilterContext context);
