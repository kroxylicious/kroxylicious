 ...
 */
public interface ProduceResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onProduceResponse(ProduceResponseData response, KrpcFilterContext context);
