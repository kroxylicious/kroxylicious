 ...
 */
public interface ProduceResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ProduceResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code ProduceResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ProduceResponseData onProduceResponse(ProduceResponseData data, FilterContext context);
}