 ...
 */
public interface ListOffsetsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onListOffsetsResponse(ListOffsetsResponseData response, KrpcFilterContext context);
