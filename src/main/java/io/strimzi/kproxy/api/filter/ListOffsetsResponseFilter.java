 ...
 */
public interface ListOffsetsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListOffsetsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code ListOffsetsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListOffsetsResponseData onListOffsetsResponse(ListOffsetsResponseData data, FilterContext context);
}