 ...
 */
public interface AllocateProducerIdsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onAllocateProducerIdsResponse(AllocateProducerIdsResponseData response, KrpcFilterContext context);
