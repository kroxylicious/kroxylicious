 ...
 */
public interface DescribeDelegationTokenRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeDelegationTokenRequest(DescribeDelegationTokenRequestData request, KrpcFilterContext context);
