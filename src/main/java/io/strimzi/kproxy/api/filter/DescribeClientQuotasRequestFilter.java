 ...
 */
public interface DescribeClientQuotasRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeClientQuotasRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeClientQuotasRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeClientQuotasRequestData onDescribeClientQuotasRequest(DescribeClientQuotasRequestData data, FilterContext context);
}