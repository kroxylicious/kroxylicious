 ...
 */
public interface BrokerHeartbeatRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onBrokerHeartbeatRequest(BrokerHeartbeatRequestData request, KrpcFilterContext context);
