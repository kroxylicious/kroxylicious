 ...
 */
public interface BrokerHeartbeatRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code BrokerHeartbeatRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code BrokerHeartbeatRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public BrokerHeartbeatRequestData onBrokerHeartbeatRequest(BrokerHeartbeatRequestData data, FilterContext context);
}