 ...
 */
public interface TxnOffsetCommitResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code TxnOffsetCommitResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code TxnOffsetCommitResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public TxnOffsetCommitResponseData onTxnOffsetCommitResponse(TxnOffsetCommitResponseData data, FilterContext context);
}