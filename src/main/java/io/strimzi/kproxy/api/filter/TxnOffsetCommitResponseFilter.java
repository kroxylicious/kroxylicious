 ...
 */
public interface TxnOffsetCommitResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onTxnOffsetCommitResponse(TxnOffsetCommitResponseData response, KrpcFilterContext context);
