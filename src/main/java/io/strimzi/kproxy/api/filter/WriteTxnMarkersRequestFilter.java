 ...
 */
public interface WriteTxnMarkersRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onWriteTxnMarkersRequest(WriteTxnMarkersRequestData request, KrpcFilterContext context);
