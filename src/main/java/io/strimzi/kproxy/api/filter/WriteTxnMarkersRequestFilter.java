 ...
 */
public interface WriteTxnMarkersRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code WriteTxnMarkersRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code WriteTxnMarkersRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public WriteTxnMarkersRequestData onWriteTxnMarkersRequest(WriteTxnMarkersRequestData data, FilterContext context);
}