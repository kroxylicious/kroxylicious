 ...
 */
public interface UnregisterBrokerResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onUnregisterBrokerResponse(UnregisterBrokerResponseData response, KrpcFilterContext context);
