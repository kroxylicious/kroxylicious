 ...
 */
public interface UnregisterBrokerResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code UnregisterBrokerResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code UnregisterBrokerResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public UnregisterBrokerResponseData onUnregisterBrokerResponse(UnregisterBrokerResponseData data, FilterContext context);
}