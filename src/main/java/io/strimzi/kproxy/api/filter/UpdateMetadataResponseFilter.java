 ...
 */
public interface UpdateMetadataResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onUpdateMetadataResponse(UpdateMetadataResponseData response, KrpcFilterContext context);
