 ...
 */
public interface AddPartitionsToTxnResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AddPartitionsToTxnResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code AddPartitionsToTxnResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AddPartitionsToTxnResponseData onAddPartitionsToTxnResponse(AddPartitionsToTxnResponseData data, FilterContext context);
}