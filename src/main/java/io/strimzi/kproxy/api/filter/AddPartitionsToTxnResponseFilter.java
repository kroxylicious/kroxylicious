 ...
 */
public interface AddPartitionsToTxnResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onAddPartitionsToTxnResponse(AddPartitionsToTxnResponseData response, KrpcFilterContext context);
