 ...
 */
public interface ExpireDelegationTokenResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onExpireDelegationTokenResponse(ExpireDelegationTokenResponseData response, KrpcFilterContext context);
