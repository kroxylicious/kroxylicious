 ...
 */
public interface DescribeConfigsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeConfigsResponse(DescribeConfigsResponseData response, KrpcFilterContext context);
