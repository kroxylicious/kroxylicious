 ...
 */
public interface DescribeConfigsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeConfigsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeConfigsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeConfigsResponseData onDescribeConfigsResponse(DescribeConfigsResponseData data, FilterContext context);
}