...
public interface FetchResponseFilter {
     ...
     * returning the {@code FetchResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code FetchResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public FetchResponseData onFetchResponse(FetchResponseData data, FilterContext context);
}