 ...
 */
public interface DescribeGroupsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeGroupsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeGroupsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeGroupsResponseData onDescribeGroupsResponse(DescribeGroupsResponseData data, FilterContext context);
}