 ...
 */
public interface DescribeGroupsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeGroupsResponse(DescribeGroupsResponseData response, KrpcFilterContext context);
