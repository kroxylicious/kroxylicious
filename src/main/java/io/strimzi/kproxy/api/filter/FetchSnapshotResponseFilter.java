 ...
 */
public interface FetchSnapshotResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onFetchSnapshotResponse(FetchSnapshotResponseData response, KrpcFilterContext context);
