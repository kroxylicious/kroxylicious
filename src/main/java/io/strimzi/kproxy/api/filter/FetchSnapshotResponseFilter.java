 ...
 */
public interface FetchSnapshotResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code FetchSnapshotResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code FetchSnapshotResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public FetchSnapshotResponseData onFetchSnapshotResponse(FetchSnapshotResponseData data, FilterContext context);
}