 ...
 */
public interface DescribeClientQuotasResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeClientQuotasResponse(DescribeClientQuotasResponseData response, KrpcFilterContext context);
