 ...
 */
public interface DescribeQuorumResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeQuorumResponse(DescribeQuorumResponseData response, KrpcFilterContext context);
