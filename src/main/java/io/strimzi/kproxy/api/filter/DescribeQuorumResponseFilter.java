 ...
 */
public interface DescribeQuorumResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeQuorumResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeQuorumResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeQuorumResponseData onDescribeQuorumResponse(DescribeQuorumResponseData data, FilterContext context);
}