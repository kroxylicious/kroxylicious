 ...
 */
public interface BrokerRegistrationResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onBrokerRegistrationResponse(BrokerRegistrationResponseData response, KrpcFilterContext context);
