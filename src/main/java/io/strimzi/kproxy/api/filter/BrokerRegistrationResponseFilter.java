 ...
 */
public interface BrokerRegistrationResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code BrokerRegistrationResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code BrokerRegistrationResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public BrokerRegistrationResponseData onBrokerRegistrationResponse(BrokerRegistrationResponseData data, FilterContext context);
}