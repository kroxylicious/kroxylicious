 ...
 */
public interface AlterReplicaLogDirsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterReplicaLogDirsRequest(AlterReplicaLogDirsRequestData request, KrpcFilterContext context);
