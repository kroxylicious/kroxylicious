 ...
 */
public interface AlterReplicaLogDirsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterReplicaLogDirsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterReplicaLogDirsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterReplicaLogDirsRequestData onAlterReplicaLogDirsRequest(AlterReplicaLogDirsRequestData data, FilterContext context);
}