 ...
 */
public interface AlterClientQuotasResponseFilter {
     ...
     * @return the {@code AlterClientQuotasResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterClientQuotasResponseData onAlterClientQuotasResponse(AlterClientQuotasResponseData data, FilterContext context);
}