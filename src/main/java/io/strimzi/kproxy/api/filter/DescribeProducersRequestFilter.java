 ...
 */
public interface DescribeProducersRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeProducersRequest(DescribeProducersRequestData request, KrpcFilterContext context);
