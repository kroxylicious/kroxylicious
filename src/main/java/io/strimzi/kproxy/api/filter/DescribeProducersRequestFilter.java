 ...
 */
public interface DescribeProducersRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeProducersRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeProducersRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeProducersRequestData onDescribeProducersRequest(DescribeProducersRequestData data, FilterContext context);
}