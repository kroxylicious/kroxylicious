 ...
 */
public interface FetchRequestFilter {
     ...
     * @return the {@code FetchRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public FetchRequestData onFetchRequest(FetchRequestData data, FilterContext context);
}