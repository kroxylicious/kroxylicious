 ...
 */
public interface SyncGroupRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code SyncGroupRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code SyncGroupRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public SyncGroupRequestData onSyncGroupRequest(SyncGroupRequestData data, FilterContext context);
}