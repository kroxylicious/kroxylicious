 ...
 */
public interface SyncGroupRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onSyncGroupRequest(SyncGroupRequestData request, KrpcFilterContext context);
