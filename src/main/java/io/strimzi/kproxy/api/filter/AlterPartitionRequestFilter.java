 ...
 */
public interface AlterPartitionRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterPartitionRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterPartitionRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterPartitionRequestData onAlterPartitionRequest(AlterPartitionRequestData data, FilterContext context);
}