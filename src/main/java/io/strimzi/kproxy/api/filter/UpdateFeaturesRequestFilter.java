 ...
 */
public interface UpdateFeaturesRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onUpdateFeaturesRequest(UpdateFeaturesRequestData request, KrpcFilterContext context);
