 ...
 */
public interface AlterPartitionResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterPartitionResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterPartitionResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterPartitionResponseData onAlterPartitionResponse(AlterPartitionResponseData data, FilterContext context);
}