 ...
 */
public interface EnvelopeResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onEnvelopeResponse(EnvelopeResponseData response, KrpcFilterContext context);
