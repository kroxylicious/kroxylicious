 ...
 */
public interface EnvelopeResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code EnvelopeResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code EnvelopeResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public EnvelopeResponseData onEnvelopeResponse(EnvelopeResponseData data, FilterContext context);
}