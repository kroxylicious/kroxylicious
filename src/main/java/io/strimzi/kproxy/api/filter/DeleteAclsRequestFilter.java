 ...
 */
public interface DeleteAclsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteAclsRequest(DeleteAclsRequestData request, KrpcFilterContext context);
