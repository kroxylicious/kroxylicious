 ...
 */
public interface DeleteAclsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteAclsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteAclsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteAclsRequestData onDeleteAclsRequest(DeleteAclsRequestData data, FilterContext context);
}