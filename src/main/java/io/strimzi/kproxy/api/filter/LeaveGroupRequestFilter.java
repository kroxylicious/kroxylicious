 ...
 */
public interface LeaveGroupRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onLeaveGroupRequest(LeaveGroupRequestData request, KrpcFilterContext context);
