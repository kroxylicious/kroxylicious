 ...
 */
public interface LeaderAndIsrRequestFilter {
     ...
     * @return the {@code LeaderAndIsrRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public LeaderAndIsrRequestData onLeaderAndIsrRequest(LeaderAndIsrRequestData data, FilterContext context);
}