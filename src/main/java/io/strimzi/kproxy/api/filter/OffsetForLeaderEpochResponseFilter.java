 ...
 */
public interface OffsetForLeaderEpochResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetForLeaderEpochResponse(OffsetForLeaderEpochResponseData response, KrpcFilterContext context);
