 ...
 */
public interface DescribeLogDirsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeLogDirsRequest(DescribeLogDirsRequestData request, KrpcFilterContext context);
