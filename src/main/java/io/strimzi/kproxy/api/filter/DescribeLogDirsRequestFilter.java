 ...
 */
public interface DescribeLogDirsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeLogDirsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeLogDirsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeLogDirsRequestData onDescribeLogDirsRequest(DescribeLogDirsRequestData data, FilterContext context);
}