 ...
 */
public interface ListTransactionsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onListTransactionsRequest(ListTransactionsRequestData request, KrpcFilterContext context);
