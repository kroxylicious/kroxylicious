 ...
 */
public interface ListTransactionsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListTransactionsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ListTransactionsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListTransactionsRequestData onListTransactionsRequest(ListTransactionsRequestData data, FilterContext context);
}