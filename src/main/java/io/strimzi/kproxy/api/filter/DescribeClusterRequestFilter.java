 ...
 */
public interface DescribeClusterRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeClusterRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeClusterRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeClusterRequestData onDescribeClusterRequest(DescribeClusterRequestData data, FilterContext context);
}