 ...
 */
public interface DescribeClusterRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeClusterRequest(DescribeClusterRequestData request, KrpcFilterContext context);
