 ...
 */
public interface DescribeGroupsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeGroupsRequest(DescribeGroupsRequestData request, KrpcFilterContext context);
