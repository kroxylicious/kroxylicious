 ...
 */
public interface DescribeGroupsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeGroupsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeGroupsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeGroupsRequestData onDescribeGroupsRequest(DescribeGroupsRequestData data, FilterContext context);
}