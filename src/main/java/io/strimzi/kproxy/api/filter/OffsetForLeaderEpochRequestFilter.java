 ...
 */
public interface OffsetForLeaderEpochRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code OffsetForLeaderEpochRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code OffsetForLeaderEpochRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public OffsetForLeaderEpochRequestData onOffsetForLeaderEpochRequest(OffsetForLeaderEpochRequestData data, FilterContext context);
}