 ...
 */
public interface OffsetForLeaderEpochRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onOffsetForLeaderEpochRequest(OffsetForLeaderEpochRequestData request, KrpcFilterContext context);
