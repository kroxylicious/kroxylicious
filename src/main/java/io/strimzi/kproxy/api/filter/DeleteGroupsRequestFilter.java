 ...
 */
public interface DeleteGroupsRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteGroupsRequest(DeleteGroupsRequestData request, KrpcFilterContext context);
