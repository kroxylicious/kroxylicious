 ...
 */
public interface DeleteGroupsRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteGroupsRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteGroupsRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteGroupsRequestData onDeleteGroupsRequest(DeleteGroupsRequestData data, FilterContext context);
}