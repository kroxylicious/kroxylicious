 ...
 */
public interface ListGroupsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onListGroupsResponse(ListGroupsResponseData response, KrpcFilterContext context);
