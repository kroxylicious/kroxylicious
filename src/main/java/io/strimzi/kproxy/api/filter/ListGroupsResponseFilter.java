 ...
 */
public interface ListGroupsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ListGroupsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code ListGroupsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public ListGroupsResponseData onListGroupsResponse(ListGroupsResponseData data, FilterContext context);
}