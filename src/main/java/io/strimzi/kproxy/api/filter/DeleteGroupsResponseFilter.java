 ...
 */
public interface DeleteGroupsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteGroupsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteGroupsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteGroupsResponseData onDeleteGroupsResponse(DeleteGroupsResponseData data, FilterContext context);
}