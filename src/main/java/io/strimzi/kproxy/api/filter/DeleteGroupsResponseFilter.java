 ...
 */
public interface DeleteGroupsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteGroupsResponse(DeleteGroupsResponseData response, KrpcFilterContext context);
