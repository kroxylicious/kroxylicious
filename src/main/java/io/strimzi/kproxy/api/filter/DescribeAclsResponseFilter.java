 ...
 */
public interface DescribeAclsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DescribeAclsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DescribeAclsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DescribeAclsResponseData onDescribeAclsResponse(DescribeAclsResponseData data, FilterContext context);
}