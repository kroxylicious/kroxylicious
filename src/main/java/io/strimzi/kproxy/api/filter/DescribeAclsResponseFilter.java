 ...
 */
public interface DescribeAclsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDescribeAclsResponse(DescribeAclsResponseData response, KrpcFilterContext context);
