 ...
 */
public interface AddPartitionsToTxnRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AddPartitionsToTxnRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code AddPartitionsToTxnRequestData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AddPartitionsToTxnRequestData onAddPartitionsToTxnRequest(AddPartitionsToTxnRequestData data, FilterContext context);
}