 ...
 */
public interface AddPartitionsToTxnRequestFilter extends KrpcRequestFilter {
    /**
     ...
     */
    public KrpcFilterState onAddPartitionsToTxnRequest(AddPartitionsToTxnRequestData request, KrpcFilterContext context);
