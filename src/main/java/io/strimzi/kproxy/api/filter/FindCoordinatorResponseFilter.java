 ...
 */
public interface FindCoordinatorResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code FindCoordinatorResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code FindCoordinatorResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public FindCoordinatorResponseData onFindCoordinatorResponse(FindCoordinatorResponseData data, FilterContext context);
}