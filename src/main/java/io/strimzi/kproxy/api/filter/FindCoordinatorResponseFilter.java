 ...
 */
public interface FindCoordinatorResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onFindCoordinatorResponse(FindCoordinatorResponseData response, KrpcFilterContext context);
