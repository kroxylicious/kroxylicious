 ...
 */
public interface DeleteAclsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onDeleteAclsResponse(DeleteAclsResponseData response, KrpcFilterContext context);
