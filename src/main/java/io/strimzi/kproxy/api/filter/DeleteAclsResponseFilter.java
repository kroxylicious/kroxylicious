 ...
 */
public interface DeleteAclsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code DeleteAclsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code DeleteAclsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public DeleteAclsResponseData onDeleteAclsResponse(DeleteAclsResponseData data, FilterContext context);
}