 ...
 */
public interface AlterReplicaLogDirsResponseFilter extends KrpcResponseFilter {
    /**
     ...
     */
    public KrpcFilterState onAlterReplicaLogDirsResponse(AlterReplicaLogDirsResponseData response, KrpcFilterContext context);
