 ...
 */
public interface AlterReplicaLogDirsResponseFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code AlterReplicaLogDirsResponseData} instance to be passed to the next filter.
     ...
     * @return the {@code AlterReplicaLogDirsResponseData} instance to be passed to the next filter.
     * If null is returned then the given {code data} will be used.
     */
    public AlterReplicaLogDirsResponseData onAlterReplicaLogDirsResponse(AlterReplicaLogDirsResponseData data, FilterContext context);
}