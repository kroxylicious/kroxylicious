 ...
 */
public interface ProduceRequestFilter {

    /**
     * Handle the given {@code data},
     * returning the {@code ProduceRequestData} instance to be passed to the next filter.
     ...
     * @return the {@code ProduceRequestData} instance to be passed to the next filter.
