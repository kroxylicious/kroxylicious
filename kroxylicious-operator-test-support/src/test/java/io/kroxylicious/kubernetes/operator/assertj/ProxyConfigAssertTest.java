...
class ProxyConfigAssertTest {
    ...
    void sniHostIdentifiesNodeGateway() {
        SniHostIdentifiesNodeIdentificationStrategy strategy = new SniHostIdentifiesNodeIdentificationStrategy(HostPort.parse("abc:123"), "localhost");
        VirtualClusterGateway virtualClusterGateway = new VirtualClusterGateway("default",
    ...
    @Test
    void sniHostIdentifiesNodeGateway_BootstrapHost() {
        SniHostIdentifiesNodeIdentificationStrategy strategy = new SniHostIdentifiesNodeIdentificationStrategy(HostPort.parse("abc:123"), "localhost");
        VirtualClusterGateway virtualClusterGateway = new VirtualClusterGateway("default",
                null, strategy, Optional.of(new Tls(null, null, null, null)));
        ProxyConfigAssert.ProxyConfigGatewayAssert gatewayAssert = new ProxyConfigAssert.ProxyConfigGatewayAssert(virtualClusterGateway);
        ProxyConfigAssert.ProxyConfigSniHostIdentifiesNodeGatewayAssert sniHostIdentifiesNodeGatewayAssert = gatewayAssert.sniHostIdentifiesNode();
        Assertions.assertThat(sniHostIdentifiesNodeGatewayAssert.bootstrapAddress().host().isEqualTo("abc").isNotEqualTo("def"));
    }

    @Test
    void sniHostIdentifiesNodeGateway_BootstrapPort() {
        SniHostIdentifiesNodeIdentificationStrategy strategy = new SniHostIdentifiesNodeIdentificationStrategy(HostPort.parse("abc:123"), "localhost");
        VirtualClusterGateway virtualClusterGateway = new VirtualClusterGateway("default",
                null, strategy, Optional.of(new Tls(null, null, null, null)));
        ProxyConfigAssert.ProxyConfigGatewayAssert gatewayAssert = new ProxyConfigAssert.ProxyConfigGatewayAssert(virtualClusterGateway);
        ProxyConfigAssert.ProxyConfigSniHostIdentifiesNodeGatewayAssert sniHostIdentifiesNodeGatewayAssert = gatewayAssert.sniHostIdentifiesNode();
        Assertions.assertThat(sniHostIdentifiesNodeGatewayAssert.bootstrapAddress().port().isEqualTo(123).isNotEqualTo(456));
    }
    ...
    void sniHostIdentifiesNodeGateway_AdvertisedBrokerAddressPattern() {
        ...
        ProxyConfigAssert.ProxyConfigGatewayAssert gatewayAssert = new ProxyConfigAssert.ProxyConfigGatewayAssert(virtualClusterGateway);
        ProxyConfigAssert.ProxyConfigSniHostIdentifiesNodeGatewayAssert sniHostIdentifiesNodeGatewayAssert = gatewayAssert.sniHostIdentifiesNode();
        Assertions.assertThat(sniHostIdentifiesNodeGatewayAssert.advertisedBrokerAddressPattern().isEqualTo("localhost").isNotEqualTo("abc"));
    }
