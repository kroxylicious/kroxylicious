...
* `AWS_ACCESS_KEY_ID`: key id of the aws account to be used for KMS. Localstack will be used by default. Default value: `test`
* `AWS_SECRET_ACCESS_KEY`: secret access key of the aws account to be used for KMS. Localstack will be used by default. Default value: `test` 
