...
public class ProduceValidation implements FilterFactory<ValidationConfig, ValidationConfig> {
    ...
    @Override
    public Filter createFilter(FilterFactoryContext context, ValidationConfig configuration) {
        ProduceRequestValidator validator = ProduceValidationFilterBuilder.build(configuration);
        return new Filter(configuration.isForwardPartialRequests(), validator);
    }
     ...
     * </p>
     */
    public static class Filter implements ProduceRequestFilter, ProduceResponseFilter {
         ...
         */
        public Filter(boolean forwardPartialRequests, ProduceRequestValidator validator) {
            if (validator == null) {
