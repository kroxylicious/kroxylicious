...
public class MultiTenantTransformationFilter
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onMetadataRequest(short apiVersion, RequestHeaderData header, MetadataRequestData request, FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onMetadataResponse(short apiVersion, ResponseHeaderData header, MetadataResponseData response,
                                                                     FilterContext context) {
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onListOffsetsRequest(short apiVersion, RequestHeaderData header, ListOffsetsRequestData request,
                                                                      FilterContext context) {
        request.topics().forEach(topic -> applyTenantPrefix(context, topic::name, topic::setName, false));
        return context.forwardRequest(header, request);
    }
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onListOffsetsResponse(short apiVersion, ResponseHeaderData header, ListOffsetsResponseData response,
                                                                        FilterContext context) {
        response.topics().forEach(topic -> removeTenantPrefix(context, topic::name, topic::setName, false));
        return context.forwardResponse(header, response);
    }
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onOffsetFetchRequest(short apiVersion, RequestHeaderData header, OffsetFetchRequestData request,
                                                                      FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onOffsetFetchResponse(short apiVersion, ResponseHeaderData header, OffsetFetchResponseData response,
                                                                        FilterContext context) {
        response.topics().forEach(topic -> removeTenantPrefix(context, topic::name, topic::setName, false));
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onOffsetForLeaderEpochRequest(short apiVersion, RequestHeaderData header, OffsetForLeaderEpochRequestData request,
                                                                               FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onOffsetForLeaderEpochResponse(short apiVersion, ResponseHeaderData header, OffsetForLeaderEpochResponseData response,
                                                                                 FilterContext context) {
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onOffsetCommitRequest(short apiVersion, RequestHeaderData header, OffsetCommitRequestData request,
                                                                       FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onOffsetCommitResponse(short apiVersion, ResponseHeaderData header, OffsetCommitResponseData response,
                                                                         FilterContext context) {
        response.topics().forEach(topic -> removeTenantPrefix(context, topic::name, topic::setName, false));
        return context.forwardResponse(header, response);
    }
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onOffsetDeleteRequest(short apiVersion, RequestHeaderData header, OffsetDeleteRequestData request,
                                                                       FilterContext context) {
        applyTenantPrefix(context, request::groupId, request::setGroupId, false);
        request.topics().forEach(topic -> applyTenantPrefix(context, topic::name, topic::setName, false));
        return context.forwardRequest(header, request);
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onOffsetDeleteResponse(short apiVersion, ResponseHeaderData header, OffsetDeleteResponseData response,
                                                                         FilterContext context) {
        response.topics().forEach(topic -> removeTenantPrefix(context, topic::name, topic::setName, false));
        return context.forwardResponse(header, response);
    }
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onFindCoordinatorRequest(short apiVersion, RequestHeaderData header, FindCoordinatorRequestData request,
                                                                          FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onFindCoordinatorResponse(short apiVersion, ResponseHeaderData header, FindCoordinatorResponseData response,
                                                                            FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onListGroupsResponse(short apiVersion, ResponseHeaderData header, ListGroupsResponseData response,
                                                                       FilterContext context) {
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onJoinGroupRequest(short apiVersion, RequestHeaderData header, JoinGroupRequestData request,
                                                                    FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onSyncGroupRequest(short apiVersion, RequestHeaderData header, SyncGroupRequestData request,
                                                                    FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
        request.setGroupId(tenantPrefix + request.groupId());
        return context.forwardRequest(header, request);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onLeaveGroupRequest(short apiVersion, RequestHeaderData header, LeaveGroupRequestData request,
                                                                     FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
        request.setGroupId(tenantPrefix + request.groupId());
        return context.forwardRequest(header, request);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onHeartbeatRequest(short apiVersion, RequestHeaderData header, HeartbeatRequestData request,
                                                                    FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
        request.setGroupId(tenantPrefix + request.groupId());
        return context.forwardRequest(header, request);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onInitProducerIdRequest(short apiVersion, RequestHeaderData header, InitProducerIdRequestData request,
                                                                         FilterContext context) {
        applyTenantPrefix(context, request::transactionalId, request::setTransactionalId, true);
        return context.forwardRequest(header, request);
    }
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onAddPartitionsToTxnRequest(short apiVersion, RequestHeaderData header, AddPartitionsToTxnRequestData request,
                                                                             FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onAddPartitionsToTxnResponse(short apiVersion, ResponseHeaderData header, AddPartitionsToTxnResponseData response,
                                                                               FilterContext context) {
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onAddOffsetsToTxnRequest(short apiVersion, RequestHeaderData header, AddOffsetsToTxnRequestData request,
                                                                          FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onTxnOffsetCommitRequest(short apiVersion, RequestHeaderData header, TxnOffsetCommitRequestData request,
                                                                          FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
        request.setTransactionalId(tenantPrefix + request.transactionalId());
        request.setGroupId(tenantPrefix + request.groupId());
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onTxnOffsetCommitResponse(short apiVersion, ResponseHeaderData header, TxnOffsetCommitResponseData response,
                                                                            FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onListTransactionsResponse(short apiVersion, ResponseHeaderData header, ListTransactionsResponseData response,
                                                                             FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onDescribeTransactionsRequest(short apiVersion, RequestHeaderData header, DescribeTransactionsRequestData request,
                                                                               FilterContext context) {
    ...
    @Override
    public CompletionStage<ResponseFilterCommand> onDescribeTransactionsResponse(short apiVersion, ResponseHeaderData header, DescribeTransactionsResponseData response,
                                                                                 FilterContext context) {
    ...
    @Override
    public CompletionStage<RequestFilterCommand> onEndTxnRequest(short apiVersion, RequestHeaderData header, EndTxnRequestData request, FilterContext context) {
        var tenantPrefix = getTenantPrefix(context);
        request.setTransactionalId(tenantPrefix + request.transactionalId());
        return context.forwardRequest(header, request);
    }
