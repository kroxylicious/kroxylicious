...
<#macro mapRequestFields messageSpec fieldVar children indent>
    ...
    <#list children>
        ...
        ${pad}                  r -> EntityIsolation.fromResourceTypeCode(ApiKeys.${inputSpec.kafkaApiKeyEnumName}, r.resourceType())))
        ${pad}            .entrySet()
        ${pad}            .stream()
...
${pad}        EntityIsolation.fromResourceTypeCode(ApiKeys.${inputSpec.kafkaApiKeyEnumName}, ${elementVar}.resourceType())
