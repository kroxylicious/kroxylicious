...
/**
* Entity isolation processor for ${inputSpec.apiKeyEnumName}.
*/
...
<#if inputSpec.request.hasAtLeastOneEntityField(filteredEntityTypes)>
    <#assign key="${inputSpec.apiKeyEnumName}" dataClass="${inputSpec.request.dataClassName}"/>
    @Override
...
<#if inputSpec.response.hasAtLeastOneEntityField(filteredEntityTypes)>
    <#assign key="${inputSpec.apiKeyEnumName}" dataClass="${inputSpec.response.dataClassName}"/>
    @Override
