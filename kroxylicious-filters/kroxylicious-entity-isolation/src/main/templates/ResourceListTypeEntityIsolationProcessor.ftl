...
class ${messageSpecPair.name}EntityIsolationProcessor implements EntityIsolationProcessor<${messageSpecPair.request.dataClassName}, ${messageSpecPair.response.dataClassName}> {
