...
import io.kroxylicious.filter.entityisolation.EntityIsolation;import io.kroxylicious.proxy.filter.FilterContext;
...
class ${messageSpec.name}EntityIsolationProcessor implements EntityIsolationProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(${messageSpec.name}EntityIsolationProcessor.class);
