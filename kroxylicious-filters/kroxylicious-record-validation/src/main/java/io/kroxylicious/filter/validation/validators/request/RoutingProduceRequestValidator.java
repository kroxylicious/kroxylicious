...
public class RoutingProduceRequestValidator implements ProduceRequestValidator {
    ...
    public CompletionStage<ProduceRequestValidationResult> validateRequest(List<NamedTopicProduceData> topidData) {
        CompletableFuture<TopicValidationResult>[] results = topidData.stream()
                .map(topicProduceData -> validateTopicProduceData(topicProduceData))
