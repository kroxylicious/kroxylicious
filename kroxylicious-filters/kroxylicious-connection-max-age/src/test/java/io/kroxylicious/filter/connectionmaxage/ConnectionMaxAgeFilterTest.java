...
class ConnectionMaxAgeFilterTest {
    ...
    void shouldCloseConnectionWhenMaxAgeExceeded() {
        ...
        ConnectionMaxAgeFilter filterUnderTest = new ConnectionMaxAgeFilter(Duration.ofMinutes(5), mutableClock);
    ...
    void shouldNotCloseConnectionWhenExactlyAtDeadline() {
        MutableClock mutableClock = MutableClock.of(NOW, ZONE);
        ConnectionMaxAgeFilter filter = new ConnectionMaxAgeFilter(Duration.ofMinutes(5), mutableClock);
