...
@Plugin(configType = PrincipalResourceNameMapperService.Config.class)
public class PrincipalResourceNameMapperService implements ResourceNameMapperService<PrincipalResourceNameMapperService.Config> {
    ...
    public ResourceNameMapper build() {
        ...
        return new PrincipalResourceNameMapper(Objects.requireNonNull(config.principalType()));
    }
