...
class UserPrincipalPrefixingResourceNameMapperTest {
    ...
    void map() {
        ...
        assertThat(mapper.map(mapperContext, ResourceIsolation.ResourceType.TOPIC_NAME, "foo"))
                .isEqualTo("bob-foo");
    }
    ...
    void unmap() {
        var mapperContext = buildMapperContext(subject);
        assertThat(mapper.unmap(mapperContext, ResourceIsolation.ResourceType.TOPIC_NAME, "bob-foo"))
                .isEqualTo("foo");
    }
    ...
    void shouldRejectOutOfNamespaceResourceName() {
        var mapperContext = buildMapperContext(subject);
        assertThatThrownBy(() -> mapper.unmap(mapperContext, ResourceIsolation.ResourceType.TOPIC_NAME, "alice-foo"))
    ...
    void isInNamespace() {
        var mapperContext = buildMapperContext(subject);
        assertThat(mapper.isInNamespace(mapperContext, ResourceIsolation.ResourceType.TOPIC_NAME, "bob-foo"))
                .isTrue();
    }
