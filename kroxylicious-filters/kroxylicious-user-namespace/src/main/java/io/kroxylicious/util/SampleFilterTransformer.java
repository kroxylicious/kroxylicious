...
public class SampleFilterTransformer {
     ...
     */
    public static void transform(ProduceRequestData.PartitionProduceData partitionData, FilterContext context, UserNamespace.SampleFilterConfig config) {
     ...
     * @param config the transform configuration
     */
    public static void transform(FetchResponseData.PartitionData partitionData, FilterContext context, UserNamespace.SampleFilterConfig config) {
        partitionData.setRecords(transformPartitionRecords((AbstractRecords) partitionData.records(), context, config.getFindValue(), config.getReplacementValue()));
    }
