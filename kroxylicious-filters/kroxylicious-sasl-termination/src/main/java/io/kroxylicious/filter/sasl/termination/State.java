...
sealed interface State permits State.RequiringHandshake, State.RequiringAuthenticate, State.Authenticated, State.Failed {
    ...
    final class RequiringAuthenticate implements State {
         ...
         */
        public Authenticated nextStateSuccess(String authorizationId, @Nullable Instant sessionExpiry) {
            return new Authenticated(authorizationId, sessionExpiry);
        }
    ...
    final class Authenticated implements State {
        ...
        private Authenticated(String authorizationId, @Nullable Instant sessionExpiry) {
         ...
         *
         * @param mechanismHandler the handler for the new authentication session
         * @return the requiring authenticate state
         */
        public RequiringAuthenticate nextStateReauthenticate(MechanismHandler mechanismHandler) {
            return new RequiringAuthenticate(mechanismHandler);
        }
