...
/**
 * Configuration for the SCRAM-SHA-512 mechanism.
 *
 ...
 */
public record ScramSha512MechanismConfig(
    ...
    private static final String MECHANISM_NAME = "SCRAM-SHA-512";

    public ScramSha512MechanismConfig {
