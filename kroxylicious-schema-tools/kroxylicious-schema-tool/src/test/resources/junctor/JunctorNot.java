...
public class JunctorNot {
    ...
    public JunctorNot(@edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "foo") java.lang.Boolean foo, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "bar") java.lang.Boolean bar) {
        this.foo = foo;
        this.bar = bar;
    }
    ...
    public java.lang.String toString() {
        return "JunctorNot[" + "foo: " + this.foo + ", bar: " + this.bar + "]";
    }
    ...
    public boolean equals(java.lang.Object other) {
        if (this == other)
            return true;
        else if (other instanceof junctor.JunctorNot otherJunctorNot)
            return java.util.Objects.equals(this.foo, otherJunctorNot.foo) && java.util.Objects.equals(this.bar, otherJunctorNot.bar);
        else
            return false;
    }
}
