...
public class JunctorAllOf {
    ...
    public JunctorAllOf(@edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "foo") java.lang.Boolean foo, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "bar") java.lang.Boolean bar) {
        this.foo = foo;
        this.bar = bar;
    }
