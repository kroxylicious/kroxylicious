...
public class JunctorAllOf {
    ...
    public JunctorAllOf(@com.fasterxml.jackson.annotation.JsonProperty(value = "foo") @edu.umd.cs.findbugs.annotations.Nullable java.lang.Boolean foo, @com.fasterxml.jackson.annotation.JsonProperty(value = "bar") @edu.umd.cs.findbugs.annotations.Nullable java.lang.Boolean bar) {
        this.foo = foo;
        this.bar = bar;
    }
    ...
    public java.lang.String toString() {
        return "JunctorAllOf[" + "foo: " + this.foo + ", bar: " + this.bar + "]";
    }
    ...
    public boolean equals(java.lang.Object other) {
        if (this == other)
            return true;
        else if (other instanceof junctor.JunctorAllOf otherJunctorAllOf)
            return java.util.Objects.equals(this.foo, otherJunctorAllOf.foo) && java.util.Objects.equals(this.bar, otherJunctorAllOf.bar);
        else
            return false;
    }
}
