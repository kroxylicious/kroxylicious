...
public class Arrays {
    ...
    public Arrays(@edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "strings") java.util.List<java.lang.String> strings, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "stringSet") java.util.Set<java.lang.String> stringSet, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "integers") java.util.List<java.lang.Long> integers, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "objects") java.util.List<arrays.ArraysObject> objects, @edu.umd.cs.findbugs.annotations.Nullable @com.fasterxml.jackson.annotation.JsonProperty(value = "fooBars") java.util.List<arrays.FooBar> fooBars) {
