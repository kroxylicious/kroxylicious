...
public class LocalKroxyliciousOperatorExtension implements BeforeAllCallback, AfterAllCallback, AfterEachCallback {
    ...
    /**
     * Returns a {@link ExternalOperator} scoped to the test namespace.
     * <p>
     * Use this to simulate external Kubernetes controllers (e.g. Strimzi) that set status
     * on resources the operator-under-test reads. The stub re-fetches resources before
