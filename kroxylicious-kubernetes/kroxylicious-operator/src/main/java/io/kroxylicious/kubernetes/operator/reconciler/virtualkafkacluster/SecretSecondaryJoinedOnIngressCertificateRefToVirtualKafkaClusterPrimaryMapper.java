...
class SecretSecondaryJoinedOnIngressCertificateRefToVirtualKafkaClusterPrimaryMapper implements SecondaryToPrimaryMapper<Secret> {

    private final EventSourceContext<VirtualKafkaCluster> context;

    SecretSecondaryJoinedOnIngressCertificateRefToVirtualKafkaClusterPrimaryMapper(EventSourceContext<VirtualKafkaCluster> context) {
