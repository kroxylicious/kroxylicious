                ...
                partitionDatum.setRecords(RecordStream.ofRecords(records)
                        .toMemoryRecords(
                                ...
                                new RecordTransform<>() {
                                    ...
                                    @Override
                                    public void init(@Nullable Void state, io.kroxylicious.kafka.common.record.internal.Record record) {
                                        // nothing to do
                                    }

                                    @Override
                                    public void resetAfterTransform(Void state, io.kroxylicious.kafka.common.record.internal.Record record) {
                                        // nothing to do
                                    }

                                    @Override
                                    public long transformOffset(io.kroxylicious.kafka.common.record.internal.Record record) {
                                        return record.offset();
                                    }

                                    @Override
                                    public long transformTimestamp(io.kroxylicious.kafka.common.record.internal.Record record) {
                                        return record.timestamp();
                                    }

                                    @Nullable
                                    @Override
                                    public ByteBuffer transformKey(io.kroxylicious.kafka.common.record.internal.Record record) {
                                        return record.key();
                                    }

                                    @Nullable
                                    @Override
                                    public ByteBuffer transformValue(io.kroxylicious.kafka.common.record.internal.Record record) {
                                        return record.value();
                                    }
