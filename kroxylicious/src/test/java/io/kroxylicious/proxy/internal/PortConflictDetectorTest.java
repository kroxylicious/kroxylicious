...
class PortConflictDetectorTest {
    ...
    public static Stream<Arguments> portConflict() {
        ...
        return Stream.of(
                ...
                Arguments.of("different exclusive ports on specific interface, collides with other exclusive port on any interface",
                        createMockVirtualCluster(Set.of(9080), Set.of(), loopback),
                        createMockVirtualCluster(Set.of(9081), Set.of(), loopback),
    ...
    @MethodSource
    public void portConflict(String name, VirtualCluster virtualCluster1, VirtualCluster virtualCluster2, String expectedMessageSuffix, HostPort otherExclusivePort) {
