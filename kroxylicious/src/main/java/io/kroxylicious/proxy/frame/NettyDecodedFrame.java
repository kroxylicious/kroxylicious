 ...
 *
 */
public abstract class NettyDecodedFrame<H extends ApiMessage, B extends ApiMessage>
        extends AbstractReferenceCounted
        implements Frame, DecodedFrame<H, B> {

    private static final Logger LOGGER = LoggerFactory.getLogger(NettyDecodedFrame.class);
    ...
    NettyDecodedFrame(short apiVersion, int correlationId, H header, B body) {
