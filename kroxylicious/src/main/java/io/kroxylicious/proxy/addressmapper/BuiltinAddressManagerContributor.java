...
import io.kroxylicious.proxy.addressmapper.fixedcluster.FixedSingleNodeClusterAddressManager;
import io.kroxylicious.proxy.addressmapper.fixedcluster.FixedSingleNodeClusterAddressManagerConfig;
...
public class BuiltinAddressManagerContributor extends BaseContributor<AddressManager> implements AddressManagerContributor {
    ...
    public static final BaseContributor.BaseContributorBuilder<AddressManager> ADDRESS_MANAGERS = BaseContributor.<AddressManager> builder()
            .add("FixedCluster", FixedSingleNodeClusterAddressManagerConfig.class, FixedSingleNodeClusterAddressManager::new);
