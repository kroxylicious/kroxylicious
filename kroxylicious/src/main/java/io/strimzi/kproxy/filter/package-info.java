 ...
 *
 * <p>{@link io.strimzi.kproxy.filter.KrpcRequestFilter} is the base interface for request filters,
 * with a subinterface for each request API (e.g. {@link io.strimzi.kproxy.filter.ProduceRequestFilter}).
 * Similarly {@link io.strimzi.kproxy.filter.KrpcResponseFilter} is the base interface for response filters,
 * with a subinterface for each response API (e.g. {@link io.strimzi.kproxy.filter.ProduceResponseFilter}).</p>
 *
 ...
 * <p>filter chain is instantiated by a {@link io.strimzi.kproxy.internal.FilterChainFactory}
