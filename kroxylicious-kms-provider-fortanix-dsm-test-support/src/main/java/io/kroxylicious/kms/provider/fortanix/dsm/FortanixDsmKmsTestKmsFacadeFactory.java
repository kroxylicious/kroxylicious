 ...
 */
public class FortanixDsKmsTestKmsFacadeFactory extends AbstractFortanixDsmKmsTestKmsFacadeFactory implements TestKmsFacadeFactory<Config, String, FortanixDsmKmsEdek> {
    /**
     * {@inheritDoc}
     */
    @Override
