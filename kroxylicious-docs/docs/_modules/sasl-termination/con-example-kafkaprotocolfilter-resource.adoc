    ...
    mechanisms:
      ...
      - mechanism: SCRAM-SHA-256
        ...
        credentialStoreConfig:
          ...
          filePassword:
            passwordFile: ${secret:scram-credentials:file-password}
...
The `${secret:scram-credentials:credentials.p12}` and `${secret:scram-credentials:file-password}` syntax references entries from the Kubernetes Secret named `scram-credentials`.
