...
*  if `requireAuthentication` true then successful authentication will be required before the filter will forward any requests other than those strictly required to perform SASL authentication.
