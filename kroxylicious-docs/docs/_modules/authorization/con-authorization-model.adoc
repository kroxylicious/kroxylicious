...
|WRITE
|Required for a producer or consumer client to participate in a transaction

|DESCRIBE
|Required for a producer or consumer or admin client to find and describe transactions
