...
The Filter can make use of {java-21-javadoc}/java.base/java/util/concurrent/CompletionStage.html[CompletionStage^]
...
For Kroxylicious to instantiate and configure your custom filter we use Java's {java-21-javadoc}/java.base/java/util/ServiceLoader.html[ServiceLoader^] API.
