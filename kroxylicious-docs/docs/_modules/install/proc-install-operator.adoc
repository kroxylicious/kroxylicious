...
[id='proc-install-operator-{context}']
= Installing the operator using installation files
...
* You have downloaded the xref:con-install-product-downloads-{context}[release artifacts] and extracted the contents into the current directory.
