...
[id='con-sasl-inspection-example-kafkaprotocolfilter-resource-{context}']
...
Refer to SASL mechanism by its name given in the xref:supported-mechanisms-inspection-{context}[supported mechanisms] table.
