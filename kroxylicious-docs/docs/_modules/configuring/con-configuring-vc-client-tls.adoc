...
The names of the TLS protocols are defined by {java-21-specs}/security/standard-names.html#sslcontext-algorithms[Java specification].
...
The names of the cipher suite are defined by {java-21-specs}/security/standard-names.html#jsse-cipher-suite-names[Java specification].
