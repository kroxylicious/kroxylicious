...
NOTE: For applications that use SASL authentication, see the {AuthenticationGuide} for information on building the authenticated subject using SASL Inspection (passthrough) or SASL Termination (centralized authentication).
