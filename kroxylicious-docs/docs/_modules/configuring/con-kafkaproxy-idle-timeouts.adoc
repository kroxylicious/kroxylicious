...
** A SASL inspection or termination filter invokes `clientSaslAuthenticationSuccess`.
...
You can configure one, both, or neither setting depending on your requirements.
Timeout values use a string-based duration format, following Go conventions.
