...
** `ResolvedRefs` defines the condition type to report any issues with referenced resources.
** The status value of `True` means that all referenced resources exist.
