...
<5> Network settings for the management HTTP endpoints. Can be configured independently from proxy settings.
...
[NOTE]
====
The `shutdownQuietPeriodSeconds` field (an integer number of seconds) is deprecated and will be removed in a future release.
