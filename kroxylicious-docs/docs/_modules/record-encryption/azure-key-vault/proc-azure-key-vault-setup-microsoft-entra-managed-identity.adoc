...
* The Azure resource (VM, etc.) intended to host Kroxylicious must already exist.
...
<2> The command used here depends on the hosting resource type. Replace `<RESOURCE_TYPE>` with the appropriate subcommand for your resource type (e.g., `vm`, etc.)
