...
* The command outputs the Principal ID of the managed identity. Use this identifier in the next step.
...
----
* Set `PRINCIPAL_ID` to the managed identity’s Principal ID from the previous step.
