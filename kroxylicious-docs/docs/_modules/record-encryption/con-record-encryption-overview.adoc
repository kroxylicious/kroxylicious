...
NOTE: In Azure Key Vault, RSAES-OAEP 256 bit asymmetric keys may be used instead of AES(GCM) 256 bit symmetric keys if Managed HSM is not available, but this method is not quantum-resistant.
