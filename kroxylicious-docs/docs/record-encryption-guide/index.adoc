...
include::_assemblies/record-encryption/assembly-kms-preparing.adoc[leveloffset=+1]
...
include::_assemblies/record-encryption/assembly-operations-record-encryption-filter.adoc[leveloffset=+1]
