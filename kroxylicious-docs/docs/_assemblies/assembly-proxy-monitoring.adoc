...
include::../_modules/monitoring/con-{guide}-logging-configuration.adoc[leveloffset=+1]
include::../_modules/monitoring/proc-{guide}-switching-json-log-format.adoc[leveloffset=+1]
