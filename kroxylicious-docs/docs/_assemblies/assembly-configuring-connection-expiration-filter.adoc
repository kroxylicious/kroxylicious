...
[id='assembly-configuring-connection-expiration-filter-{context}']
...
ifdef::include-platform-bare-metal[]
include::../_modules/connection-expiration/con-example-proxy-config.adoc[leveloffset=+1]
endif::[]

ifdef::include-platform-kubernetes[]
include::../_modules/connection-expiration/con-example-kafkaprotocolfilter-resource.adoc[leveloffset=+1]
endif::[]
