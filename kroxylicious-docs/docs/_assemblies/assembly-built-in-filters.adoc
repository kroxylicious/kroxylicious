...
== Connection Max Age filter

The Kroxylicious Connection Max Age filter closes client connections after a configurable maximum age.
...
For information on using the filter, see the {ConnectionMaxAgeGuide}.
