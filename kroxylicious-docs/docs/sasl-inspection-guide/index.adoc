...
[role="_abstract"]
This filter inspects the SASL exchange between Kafka Client and Broker and extracts the authorization ID.
...
.Table of supported SASL mechanisms
|===
...
//about the sasl subject builder
...
// glossary
include::_modules/sasl-inspection/ref-glossary.adoc[leveloffset=+1]